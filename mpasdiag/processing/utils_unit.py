...
class UnitConverter:
    ...
    @staticmethod
    def convert_units(
        data: Union[np.ndarray, xr.DataArray, float], from_unit: str, to_unit: str
    ...
    @staticmethod
    def convert_data_for_display(
        data: xr.DataArray, var_name: str, metadata_source: xr.DataArray
    ) -> Tuple[Union[np.ndarray, xr.DataArray, float], Dict[str, Any]]:
        """
        ...
        if original_units != display_units:
            try:
                converted_data = UnitConverter.convert_units(
                    data, original_units, display_units
                )
            except ValueError:
                display_units = original_units
    ...
    def _normalize_unit_string(unit: str) -> str:
        ...
        unit_map = {
            ...
            "deg_c": CELSIUS,
            "c": CELSIUS,
            CELSIUS.lower(): CELSIUS,
            "fahrenheit": FAHRENHEIT,
            "degf": FAHRENHEIT,
            "deg_f": FAHRENHEIT,
            "f": FAHRENHEIT,
            FAHRENHEIT.lower(): FAHRENHEIT,
            "pascal": PA,
            "pa": PA,
            PA.lower(): PA,
            "hectopascal": HPA,
            ...
            "kg_kg-1": KG_PER_KG,
            "kg kg^{-1}": KG_PER_KG,
            KG_PER_KG.lower(): KG_PER_KG,
            "g kg-1": G_PER_KG,
            "g_kg-1": G_PER_KG,
            "g kg^{-1}": G_PER_KG,
            G_PER_KG.lower(): G_PER_KG,
            "kg m-2": KG_PER_M2,
            "kg_m-2": KG_PER_M2,
            "kg m^{-2}": KG_PER_M2,
            KG_PER_M2.lower(): KG_PER_M2,
            "mm hr-1": MM_PER_HR,
            "mm_hr-1": MM_PER_HR,
            MM_PER_HR.lower(): MM_PER_HR,
            "mm day-1": MM_PER_DAY,
            "mm_day-1": MM_PER_DAY,
            MM_PER_DAY.lower(): MM_PER_DAY,
            "percent": PERCENT,
            "pct": PERCENT,
            PERCENT.lower(): PERCENT,
            "in hr-1": INCHES_PER_HR,
            "in_hr-1": INCHES_PER_HR,
            INCHES_PER_HR.lower(): INCHES_PER_HR,
            "knots": KNOT,
            "knot": KNOT,
            "kts": KNOT,
            KNOT.lower(): KNOT,
            "miles per hour": MILES_PER_HR,
            "mi/hr": MILES_PER_HR,
            MILES_PER_HR.lower(): MILES_PER_HR,
            "kilometers per hour": KM_PER_HR,
            "km hr-1": KM_PER_HR,
            "km_hr-1": KM_PER_HR,
            KM_PER_HR.lower(): KM_PER_HR,
            "m s-1": M_PER_S,
            "m_s-1": M_PER_S,
            "m s^{-1}": M_PER_S,
            M_PER_S.lower(): M_PER_S,
            "meter": METER,
            "meters": METER,
            METER.lower(): METER,
            "kilometer": KILOMETER,
    ...
    @staticmethod
    def _preferred_unit_for_match(
        current_unit: str, preferred_unit: str
    ) -> Optional[str]:
        """
    ...
    def get_display_units(variable_name: str, current_unit: str) -> str:
        ...
        display_unit_preferences = {
            ...
            "pressure_base": HPA,
            "precipw": MM,
            "precipitation": MM_PER_HR,
            "precip": MM_PER_HR,
            "precip_rate": MM_PER_HR,
            "u10": M_PER_S,
            "v10": M_PER_S,
            "wspd10": M_PER_S,
            "u": M_PER_S,
            ...
            "wind_speed": M_PER_S,
            "wind": M_PER_S,
            "uReconstructZonal": M_PER_S,
            "uReconstructMeridional": M_PER_S,
            "qv": G_PER_KG,
            "qc": G_PER_KG,
            "qr": G_PER_KG,
            "qi": G_PER_KG,
        ...
        for var_pattern, preferred_unit in display_unit_preferences.items():
            if var_pattern.lower() == var_name_lower:
                candidate_unit = UnitConverter._preferred_unit_for_match(
