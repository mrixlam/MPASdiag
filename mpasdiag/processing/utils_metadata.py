...
class MPASFileMetadata:
    ...
    def get_variable_metadata(
        ...
        standard_metadata = {
            ...
            "ivt_u": {
                ...
                "long_name": "Eastward Integrated Vapor Transport",
            },
            "ivt_v": {
                "units": KG_PER_M_PER_S,
                "long_name": "Northward Integrated Vapor Transport",
            },
            "refl10cm_max": {"units": DBZ, "long_name": "Maximum 10cm Reflectivity"},
            "refl10cm_1km": {"units": DBZ, "long_name": "10cm Reflectivity at 1km AGL"},
            "refl10cm_1km_max": {
                "units": DBZ,
                "long_name": "Maximum 10cm Reflectivity at 1km AGL",
            },
            ...
            "relhum_50hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 50 hPa",
            },
            "relhum_100hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 100 hPa",
            },
            "relhum_200hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 200 hPa",
            },
            "relhum_250hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 250 hPa",
            },
            "relhum_500hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 500 hPa",
            },
            "relhum_700hpa": {
                "units": PERCENT,
            ...
            "relhum_925hpa": {
                "units": PERCENT,
                "long_name": "Relative Humidity at 925 hPa",
            },
            "temperature_50hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 50 hPa",
            },
            "temperature_100hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 100 hPa",
            },
            "temperature_200hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 200 hPa",
            },
            "temperature_250hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 250 hPa",
            },
            "temperature_500hpa": {
                "units": KELVIN,
            ...
            "temperature_700hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 700 hPa",
            },
            "temperature_850hpa": {
                "units": KELVIN,
            ...
            "temperature_925hpa": {
                "units": KELVIN,
                "long_name": "Temperature at 925 hPa",
            },
            "height_50hpa": {
                "units": METER,
                "long_name": "Geopotential Height at 50 hPa",
            },
            "height_100hpa": {
                "units": METER,
            ...
            "height_200hpa": {
                "units": METER,
                "long_name": "Geopotential Height at 200 hPa",
            },
            "height_250hpa": {
                "units": METER,
            ...
            "height_925hpa": {
                "units": METER,
                "long_name": "Geopotential Height at 925 hPa",
            },
            ...
            "umeridional_50hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 50 hPa",
            },
            "umeridional_100hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 100 hPa",
            },
            "umeridional_200hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 200 hPa",
            },
            "umeridional_250hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 250 hPa",
            },
            "umeridional_500hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 500 hPa",
            },
            "umeridional_700hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 700 hPa",
            },
            "umeridional_850hpa": {
                "units": M_PER_S,
            ...
            "umeridional_925hpa": {
                "units": M_PER_S,
                "long_name": "Meridional Wind at 925 hPa",
            },
            "vorticity_50hpa": {
                "units": PER_S,
                "long_name": "Relative Vorticity at 50 hPa",
                "spatial_dim": "nVertices",
            },
            "vorticity_100hpa": {
                "units": PER_S,
                "long_name": "Relative Vorticity at 100 hPa",
                "spatial_dim": "nVertices",
            },
            "vorticity_200hpa": {
                "units": PER_S,
                "long_name": "Relative Vorticity at 200 hPa",
                "spatial_dim": "nVertices",
            },
            "vorticity_250hpa": {
                "units": PER_S,
            ...
            "vorticity_925hpa": {
                "units": PER_S,
                "long_name": "Relative Vorticity at 925 hPa",
                "spatial_dim": "nVertices",
            },
            "cape": {
                "units": J_PER_KG,
            ...
            "srh_0_1km": {
                "units": M2_PER_S2,
                "long_name": "Storm Relative Helicity 0-1km",
            },
            "srh_0_3km": {
                "units": M2_PER_S2,
                "long_name": "Storm Relative Helicity 0-3km",
            },
            "updraft_helicity_max": {
                "units": M2_PER_S2,
                "long_name": "Maximum Updraft Helicity",
            },
            "w_velocity_max": {
                "units": M_PER_S,
            ...
            "wind_speed_level1_max": {
                "units": M_PER_S,
                "long_name": "Maximum Wind Speed at Level 1",
            },
            ...
            "t_oml_initial": {
                "units": KELVIN,
                "long_name": "Initial Ocean Mixed Layer Temperature",
            },
            "h_oml_initial": {
                "units": METER,
                "long_name": "Initial Ocean Mixed Layer Depth",
            },
            "t_oml_200m_initial": {
                "units": KELVIN,
                "long_name": "Initial Ocean Mixed Layer Temperature (200m)",
            },
            ...
            "u": {
                "units": M_PER_S,
                "long_name": "Horizontal Velocity (U-component)",
                "spatial_dim": "nEdges",
            },
            "w": {
                "units": M_PER_S,
            ...
            "re_ice": {
                "units": MICRONS,
                "long_name": "Ice Crystal Effective Radius",
                "spatial_dim": "nCells",
            },
            "re_snow": {
                "units": MICRONS,
            ...
            "cold_pool_strength": {
                "units": M_PER_S,
                "long_name": "RKW Cold-Pool Strength (C)",
            },
        }
        ...
        metadata: Dict[str, Any] = standard_metadata.get(
            var_name.lower(),
            {"units": "", "long_name": var_name, "spatial_dim": "nCells"},
        )
        ...
        if include_visualization:
            ...
            if visualization_entry:
                ...
                metadata.update(
                    {"colormap": "viridis", "levels": None, "spatial_dims": 2}
                )

        return metadata

    @staticmethod
    def get_2d_variable_metadata(
        ...
        metadata = MPASFileMetadata.get_variable_metadata(
            var_name, data_array, include_visualization=True
        )
    ...
    @staticmethod
    def get_3d_colormap_and_levels(
        var_name: str,
        data_array: Optional[xr.DataArray] = None,
        level: Optional[Any] = None,
