...
def generate_real_data_plots() -> Optional[str]:
    ...
    try:
        ...
        output_path = output_dir / "mpasdiag_sample_plot_t2m_contourf.png"
    ...
    try:
        ...
        output_path = output_dir / "mpasdiag_sample_plot_mslp_contourf.png"
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        print(f"✅ Saved: {output_path}")
        plt.close()
    ...
    try:
        ...
        output_path = output_dir / "mpasdiag_sample_plot_q2_contourf.png"
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        print(f"✅ Saved: {output_path}")
        plt.close()
