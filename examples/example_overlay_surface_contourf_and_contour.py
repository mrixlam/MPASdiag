...
plotter.save_plot(f'./output/surface_overlay_contour_and_contourf_{valtime_str}', formats=['png'])
plotter.close_plot()

print(f"Plot saved to ./output/surface_overlay_contour_and_contourf_{valtime_str}.png")
