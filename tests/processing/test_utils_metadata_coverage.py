...
class TestGetVariableMetadataStandardNameFallback:
    ...
    def test_standard_name_used_when_long_name_absent(
        self: "TestGetVariableMetadataStandardNameFallback",
    ) -> None:
        """
    ...
    def test_long_name_takes_precedence_over_standard_name(
        self: "TestGetVariableMetadataStandardNameFallback",
    ) -> None:
        """
    ...
    def test_standard_name_fallback_on_unknown_var(
        self: "TestGetVariableMetadataStandardNameFallback",
    ) -> None:
        """
    ...
    def test_neither_long_name_nor_standard_name_leaves_default(
        self: "TestGetVariableMetadataStandardNameFallback",
    ) -> None:
        """
...
class TestGetVariableMetadataVisualizationFallback:
    ...
    def test_unknown_var_gets_viridis_colormap(
        self: "TestGetVariableMetadataVisualizationFallback",
    ) -> None:
        """
    ...
    def test_known_var_does_not_use_viridis_fallback(
        self: "TestGetVariableMetadataVisualizationFallback",
    ) -> None:
        """
    ...
    def test_unknown_var_without_include_viz_has_no_colormap(
        self: "TestGetVariableMetadataVisualizationFallback",
    ) -> None:
        """
    ...
    def test_unknown_var_with_data_array_and_viz(
        self: "TestGetVariableMetadataVisualizationFallback",
    ) -> None:
        """
