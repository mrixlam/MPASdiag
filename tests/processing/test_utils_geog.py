...
class TestExtractSpatialCoordinates:
    ...
    def test_radian_coords_converted_to_degrees(
        self: "TestExtractSpatialCoordinates", radian_dataset: xr.Dataset
    ) -> None:
        """
        ...
        result_lon, result_lat = MPASGeographicUtils.extract_spatial_coordinates(
            radian_dataset
        )
...
class TestFilterBySpatialExtent:
    ...
    def test_no_ncells_returns_data_unchanged(
        self: "TestFilterBySpatialExtent", degree_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_ncells_dimension_applies_mask(
        self: "TestFilterBySpatialExtent", degree_dataset: xr.Dataset
    ) -> None:
        """
...
class TestValidateGeographicExtent:
    ...
    def test_valid_extent(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-120.0, -80.0, 25.0, 55.0))
            is True
        )
    ...
    def test_boundary_extent(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-180.0, 180.0, -90.0, 90.0))
            is True
        )
    ...
    def test_lon_min_out_of_range(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-181.0, 0.0, -45.0, 45.0))
            is False
        )
    ...
    def test_lon_max_out_of_range(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((0.0, 181.0, -45.0, 45.0))
            is False
        )
    ...
    def test_lat_min_out_of_range(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-90.0, 90.0, -91.0, 45.0))
            is False
        )
    ...
    def test_lat_max_out_of_range(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-90.0, 90.0, -45.0, 91.0))
            is False
        )
    ...
    def test_lon_reversed(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((10.0, 5.0, -45.0, 45.0))
            is False
        )
    ...
    def test_lat_reversed(self: "TestValidateGeographicExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.validate_geographic_extent((-90.0, 90.0, 45.0, 10.0))
            is False
        )
...
class TestGetExtentFromCoordinates:
    ...
    def test_valid_coords_returns_bounding_box(
        self: "TestGetExtentFromCoordinates",
    ) -> None:
        """
    ...
    def test_buffer_expands_extent(self: "TestGetExtentFromCoordinates") -> None:
        ...
        lon_min, lon_max, lat_min, lat_max = (
            MPASGeographicUtils.get_extent_from_coordinates(lon, lat, buffer=5.0)
        )
    ...
    def test_lat_clamped_to_valid_range(self: "TestGetExtentFromCoordinates") -> None:
        ...
        _, _, _, lat_max = MPASGeographicUtils.get_extent_from_coordinates(
            lon, lat, buffer=5.0
        )
        assert lat_max <= 90.0
...
class TestCalculateSpatialResolution:
    ...
    def test_normal_data_returns_positive(
        self: "TestCalculateSpatialResolution",
    ) -> None:
        """
    ...
    def test_sampling_path_large_dataset(
        self: "TestCalculateSpatialResolution",
    ) -> None:
        """
    ...
    def test_identical_points_returns_zero(
        self: "TestCalculateSpatialResolution",
    ) -> None:
        """
...
class TestIsGlobalExtent:
    ...
    def test_global_extent_returns_true(self: "TestIsGlobalExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.is_global_extent((-180.0, 180.0, -90.0, 90.0)) is True
        )
    ...
    def test_non_global_lat_returns_false(self: "TestIsGlobalExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.is_global_extent((-180.0, 180.0, -45.0, 45.0)) is False
        )
    ...
    def test_custom_tolerance_passes(self: "TestIsGlobalExtent") -> None:
        ...
        """
        assert (
            MPASGeographicUtils.is_global_extent(
