...
class TestMultiprocessingExecution:
    ...
    def setup_method(
        self: "TestMultiprocessingExecution",
        ...
        Returns:
            None
        """
        self.manager = MPASParallelManager(
    ...
    def test_multiprocessing_map_with_args_kwargs(
        self: "TestMultiprocessingExecution",
    ) -> None:
        """
    ...
    def test_multiprocessing_map_with_errors(
        self: "TestMultiprocessingExecution",
    ) -> None:
        """
    ...
    def test_multiprocessing_fallback_on_error(
        self: "TestMultiprocessingExecution",
    ) -> None:
        """
...
class TestMultiprocessingMap:
    ...
    def test_multiprocessing_map_win32_platform(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
    ...
    def test_multiprocessing_map_darwin_platform(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
    ...
    def test_multiprocessing_map_linux_platform(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
    ...
    def test_multiprocessing_map_context_failure_fallback(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
        ...
        with patch("sys.platform", "linux"):
            ...
            with patch("mpasdiag.processing.parallel.get_context") as mock_ctx:
                ...
                assert all(isinstance(r, TaskResult) for r in results)
                assert (
                    "Context error" in output
                    or "Failed to create multiprocessing pool" in output
                )

    def test_multiprocessing_map_pool_exception_retry(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
        ...
        with patch("sys.platform", "linux"):
            ...
            with patch(
                "mpasdiag.processing.parallel.get_context",
                side_effect=failing_get_context,
            ):
                import io
                from contextlib import redirect_stdout
    ...
    def test_multiprocessing_map_verbose_output(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
    ...
    def test_multiprocessing_map_fallback_to_serial_all_methods_fail(
        self: "TestMultiprocessingMap", sample_tasks: List[int]
    ) -> None:
        """
...
class TestSerialMap:
    ...
    def test_serial_map_with_verbose(
        self: "TestSerialMap", sample_tasks: List[int]
    ) -> None:
        """
...
class TestSerialMapWithCollector:
    ...
    def test_serial_map_with_collector_enabled(
        self: "TestSerialMapWithCollector", sample_tasks: List[int]
    ) -> None:
        """
    ...
    def test_serial_map_verbose_with_stats(
        self: "TestSerialMapWithCollector", sample_tasks: List[int]
    ) -> None:
        """
...
class TestMultiprocessingBreakStatement:
    ...
    def test_multiprocessing_successful_first_attempt(
        self: "TestMultiprocessingBreakStatement", sample_tasks: List[int]
    ) -> None:
        """
...
class TestMultiprocessingResultsNoneCheck:
    ...
    def test_multiprocessing_results_none_fallback(
        self: "TestMultiprocessingResultsNoneCheck", sample_tasks: List[int]
    ) -> None:
        """
...
class TestSerialMapVerbosePath:
    ...
    def test_serial_map_calls_print_statistics(
        self: "TestSerialMapVerbosePath", sample_tasks: List[int]
    ) -> None:
        """
