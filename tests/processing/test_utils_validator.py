...
class TestDataValidatorIntegration:
    ...
    def test_real_mpas_coordinates(
        self: "TestDataValidatorIntegration",
    ...
    def test_real_mpas_precip_data(
        self: "TestDataValidatorIntegration", mpas_precip_data: np.ndarray
    ) -> None:
        """
