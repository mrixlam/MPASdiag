...
def _make_3d_ds(n_time: int = 2, n_cells: int = 5, n_vert: int = 4) -> xr.Dataset:
    """
...
class TestLookupCoordNone:
    ...
    def test_returns_values_for_first_matching_name(
        self: "TestLookupCoordNone",
    ) -> None:
        """
...
class TestExtract2DCoordinatesForVariable:
    ...
    def test_raises_value_error_when_dataset_is_none(
        self: "TestExtract2DCoordinatesForVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_probe_open_failure_covered_and_main_succeeds(
        self: "TestExtract2DCoordinatesForVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.processing.processors_3d.xr.open_dataset",
    ...
    def test_no_coords_in_grid_raises_runtime_error(
        self: "TestExtract2DCoordinatesForVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.processing.processors_3d.xr.open_dataset", return_value=empty_grid
        ):
            with pytest.raises(RuntimeError, match="Error loading coordinates"):
                proc.extract_2d_coordinates_for_variable("theta")

    def test_radian_coords_converted_to_degrees(
        self: "TestExtract2DCoordinatesForVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.processing.processors_3d.xr.open_dataset", return_value=grid_rad
        ):
            _, result_lat = proc.extract_2d_coordinates_for_variable("theta")

        assert np.allclose(result_lat, lat_rad * 180.0 / np.pi)

    def test_verbose_prints_coord_summary(
        self: "TestExtract2DCoordinatesForVariable", proc_v: "MPAS3DProcessor"
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.processing.processors_3d.xr.open_dataset", return_value=grid_ds
        ):
...
class TestFindFilesRecursive:
    ...
    def test_raises_file_not_found_when_no_files(
        self: "TestFindFilesRecursive", proc: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
    ...
    def test_raises_value_error_when_only_one_file(
        self: "TestFindFilesRecursive", proc: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
    ...
    def test_verbose_prints_file_list(
        self: "TestFindFilesRecursive", proc_v: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
...
class TestFindMpasoutFiles:
    ...
    def test_subdir_path_used_when_main_dir_fails(
        self: "TestFindMpasoutFiles", proc: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake = [
            str(tmp_path / "mpasout" / "mpasout_2024.nc"),
            str(tmp_path / "mpasout" / "mpasout_2025.nc"),
        ]

        with patch.object(
            proc, "_find_files_by_pattern", side_effect=[FileNotFoundError(), fake]
        ):
            result = proc.find_mpasout_files(str(tmp_path / "data"))

        assert result == fake

    def test_recursive_used_when_both_dirs_fail(
        self: "TestFindMpasoutFiles", proc: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake = [
            str(tmp_path / "sub" / "mpasout_2024.nc"),
            str(tmp_path / "sub" / "mpasout_2025.nc"),
        ]

        with patch.object(
            proc, "_find_files_by_pattern", side_effect=FileNotFoundError
        ):
...
class TestLoad3DDataUXarrayPath:
    ...
    def test_uxarray_path_assigns_dataset_and_returns_self(
        self: "TestLoad3DDataUXarrayPath", proc: "MPAS3DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        with patch.object(proc, "_load_data", return_value=(mock_ux, "uxarray")):
            with patch.object(
                proc, "add_spatial_coordinates", return_value=enriched_ds
            ):
...
class TestGetAvailable3DVarsError:
    ...
    def test_raises_when_dataset_none(
        self: "TestGetAvailable3DVarsError", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestValidate3DVariable:
    ...
    def test_raises_when_dataset_none(
        self: "TestValidate3DVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_raises_when_variable_not_found(
        self: "TestValidate3DVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_raises_when_variable_is_not_3d(
        self: "TestValidate3DVariable", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestResolveIntLevelExceedsMax:
    ...
    def test_exceeds_max_levels_raises(
        self: "TestResolveIntLevelExceedsMax", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestResolveStrLevelUnknown:
    ...
    def test_unknown_string_raises(
        self: "TestResolveStrLevelUnknown", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_top_returns_last_index(
        self: "TestResolveStrLevelUnknown", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestLerpVariableExceptionPath:
    ...
    def test_exception_fallback_returns_nearest_idx(
        self: "TestLerpVariableExceptionPath", proc: "MPAS3DProcessor"
    ) -> None:
        """
        ...
        idx, result = proc._lerp_variable(
            "theta", 0, 1, 0.5, mean_p, 60000.0, mock_ds, "Time", 0, "nVertLevels"
        )

        assert result is None
        assert isinstance(idx, int)

    def test_exception_fallback_verbose_prints_message(
        self: "TestLerpVariableExceptionPath", proc_v: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestInterpolateAtPressureVerbosePaths:
    ...
    def test_above_surface_verbose_prints_and_returns_zero(
    ...
    def test_above_surface_silent_returns_zero(
    ...
    def test_below_top_silent_returns_last_idx(
        self: "TestInterpolateAtPressureVerbosePaths", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_boundary_lower_idx_at_last_returns_without_interpolating(
        ...
        proc.dataset = _make_3d_ds()
        mean_p = np.array(
            [100000.0, 85000.0, 70000.0, 50000.0]
        )  # descending (surface → top)
        ds_raw = _make_3d_ds()
...
class TestResolveFloatLevelNoPressure:
    ...
    def test_raises_when_pressure_variables_absent(
        self: "TestResolveFloatLevelNoPressure", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestResolveLevelIndexInvalidType:
    ...
    def test_list_type_raises_value_error(
        self: "TestResolveLevelIndexInvalidType", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestSetLevelAttrs:
    ...
    def test_early_return_when_no_attrs_attribute(
        self: "TestSetLevelAttrs", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_int_level_adds_selected_level_attr(
        self: "TestSetLevelAttrs", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestGetVerticalDimNotThreeD:
    ...
    def test_raises_when_variable_has_no_vert_dim(
        self: "TestGetVerticalDimNotThreeD", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestPressureLevelsFromPressureVarExcept:
    ...
    def test_pressure_without_time_dim_uses_fallback(
        self: "TestPressureLevelsFromPressureVarExcept", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestRepairPressureLevels:
    ...
    def test_two_or_more_valid_levels_uses_interp(
        self: "TestRepairPressureLevels", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_exactly_one_valid_level_uses_linspace(
        self: "TestRepairPressureLevels", proc: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_zero_valid_levels_uses_logspace(
        self: "TestRepairPressureLevels", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestGetVerticalLevelsErrors:
    ...
    def test_raises_when_dataset_none(
        self: "TestGetVerticalLevelsErrors", proc: "MPAS3DProcessor"
    ) -> None:
        """
...
class TestExtractXarrayByIndex:
    ...
    def test_uses_fallback_dim_when_level_dim_absent(
        self: "TestExtractXarrayByIndex",
    ) -> None:
        """
...
class TestExtractXarrayByValue:
    ...
    def test_raises_when_coord_not_in_data(self: "TestExtractXarrayByValue") -> None:
        ...
        with pytest.raises(ValueError, match="Coordinate 'nVertLevels' not found"):
            MPAS3DProcessor._extract_xarray_by_value(
                data, 500.0, "nVertLevels", "nearest"
            )

    def test_nearest_method_selects_closest_level(
        self: "TestExtractXarrayByValue",
    ) -> None:
        """
        ...
        result = MPAS3DProcessor._extract_xarray_by_value(
            da, 900.0, "pressure", "nearest"
        )
...
class TestExtractNumpyByIndex:
    ...
    def test_3d_array_extracts_along_second_dim(
        self: "TestExtractNumpyByIndex",
    ) -> None:
        """
    ...
    def test_4d_array_extracts_along_second_dim(
        self: "TestExtractNumpyByIndex",
    ) -> None:
        """
...
class TestExtract2DFrom3D:
    ...
    def test_raises_when_neither_index_nor_value_provided(
        self: "TestExtract2DFrom3D",
    ) -> None:
        """
    ...
    def test_xarray_with_level_index_calls_extract_by_index(
        self: "TestExtract2DFrom3D",
    ) -> None:
        """
    ...
    def test_xarray_with_level_value_calls_extract_by_value(
        self: "TestExtract2DFrom3D",
    ) -> None:
        """
    ...
    def test_numpy_with_level_index_calls_extract_numpy(
        self: "TestExtract2DFrom3D",
    ) -> None:
        """
