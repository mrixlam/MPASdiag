...
def load_mpas_processor(
    verbose: bool = False, use_pure_xarray: bool = True
) -> MPAS2DProcessor:
    """
...
class TestExtract2DCoordinates:
    ...
    def setup_method(
        self: "TestExtract2DCoordinates",
        mpas_2d_processor_diag: "MPAS2DProcessor",
        mpas_data_available: bool,
    ) -> None:
        """
    ...
    def test_extract_coordinates_verbose_output(
        self: "TestExtract2DCoordinates",
    ) -> None:
        """
