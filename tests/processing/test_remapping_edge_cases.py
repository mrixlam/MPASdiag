...
class TestRemapToLatlonAllZeroData:
    ...
    def test_all_zero_data_returns_result(
        self: "TestRemapToLatlonAllZeroData", dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_all_nan_data_returns_result(
        self: "TestRemapToLatlonAllZeroData", dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_xarray_input_preserves_attrs(
        self: "TestRemapToLatlonAllZeroData", dataset: xr.Dataset
    ) -> None:
        """
