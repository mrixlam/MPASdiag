...
class TestLoadCoordinatesEarlyReturn:
    ...
    def test_second_load_with_var_name_is_noop(
        self: "TestLoadCoordinatesEarlyReturn",
    ) -> None:
        """
...
class TestLoadCoordinatesDimBranches:
    ...
    def test_nvertices_variable_uses_lonvertex_latvertex(
        self: "TestLoadCoordinatesDimBranches",
    ) -> None:
        """
    ...
    def test_nedges_variable_uses_lonedge_latedge(
        self: "TestLoadCoordinatesDimBranches",
    ) -> None:
        """
    ...
    def test_else_branch_falls_back_to_loncell_latcell(
        self: "TestLoadCoordinatesDimBranches",
    ) -> None:
        """
    ...
    def test_nvertices_lon_lat_in_degrees_after_load(
        self: "TestLoadCoordinatesDimBranches",
    ) -> None:
        """
...
class TestLoadCoordinatesMissingVars:
    ...
    def test_missing_loncell_latcell_raises(
        self: "TestLoadCoordinatesMissingVars",
    ) -> None:
        """
    ...
    def test_missing_lonvertex_latvertex_raises(
        self: "TestLoadCoordinatesMissingVars",
    ) -> None:
        """
    ...
    def test_missing_lonedge_latedge_raises(
        self: "TestLoadCoordinatesMissingVars",
    ) -> None:
        """
...
class TestLoadCoordinatesEviction:
    ...
    def test_eviction_triggered_at_max_coordinates(
        self: "TestLoadCoordinatesEviction",
    ) -> None:
        """
    ...
    def test_most_accessed_coord_survives_eviction(
        self: "TestLoadCoordinatesEviction",
    ) -> None:
        """
    ...
    def test_evict_least_accessed_coordinates_direct(
        self: "TestLoadCoordinatesEviction",
    ) -> None:
        """
    ...
    def test_evict_coordinates_empty_is_noop(
        self: "TestLoadCoordinatesEviction",
    ) -> None:
        """
...
class TestGetCoordinatesKeyError:
    ...
    def test_get_coordinates_not_loaded_raises(
        self: "TestGetCoordinatesKeyError",
    ) -> None:
        """
    ...
    def test_get_coordinates_wrong_var_raises(
        self: "TestGetCoordinatesKeyError",
    ) -> None:
        """
...
class TestGetVariableDataKeyError:
    ...
    def test_get_variable_not_loaded_raises(
        self: "TestGetVariableDataKeyError",
    ) -> None:
        """
    ...
    def test_get_variable_wrong_time_index_raises(
        self: "TestGetVariableDataKeyError",
    ) -> None:
        """
...
class TestEvictLeastAccessedEmpty:
    ...
    def test_evict_on_empty_cache_does_not_raise(
        self: "TestEvictLeastAccessedEmpty",
    ) -> None:
        """
