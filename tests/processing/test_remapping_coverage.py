...
def _make_remapper_with_weights(
    n: int = 4, tgt_shape: tuple = (2, 2), skipna: bool = False
) -> MPASRemapper:
    """
...
class TestMPASRemapperInit:
    ...
    @pytest.mark.skipif(
        not ESMPY_AVAILABLE, reason="ESMPy required to reach method check"
    )
...
class TestPrepareSourceGridBounds:
    ...
    def test_prepare_source_grid_with_bounds_adds_lon_b_lat_b(
        self: "TestPrepareSourceGridBounds",
    ) -> None:
        """
        ...
        result = remapper.prepare_source_grid(
            lon, lat, lon_bounds=lon_bounds, lat_bounds=lat_bounds
        )
...
class TestResolveGridsErrors:
    ...
    def test_resolve_grids_raises_without_source_grid(
        self: "TestResolveGridsErrors",
    ) -> None:
        """
...
class TestSyncWeightsAcrossRanks:
    ...
    def test_rank0_no_file_calls_barrier_and_broadcast(
        self: "TestSyncWeightsAcrossRanks",
    ) -> None:
        """
        ...
        def _bcast(data: dict, root: int = 0) -> dict:
            """
    ...
    def test_rank1_with_file_loads_weights(
        self: "TestSyncWeightsAcrossRanks", tmp_path: "Path"
    ) -> None:
        """
    ...
    def test_rank0_with_file_only_calls_barrier(
        self: "TestSyncWeightsAcrossRanks", tmp_path: "Path"
    ) -> None:
        """
...
class TestBuildRegridderMPI:
    ...
    def test_mpi_comm_triggers_sync(self: "TestBuildRegridderMPI") -> None:
        ...
        with (
            patch.object(remapper, "_build_weights_on_rank0"),
...
class TestBroadcastWeightsInMemory:
    ...
    def test_rank0_broadcasts_weight_arrays(
        self: "TestBroadcastWeightsInMemory",
    ) -> None:
        """
        ...
        def mock_bcast(data: dict, root: int = 0) -> dict:
            """
    ...
    def test_rank1_receives_and_reconstructs_weights(
        self: "TestBroadcastWeightsInMemory",
    ) -> None:
        """
        ...
        Returns:
            None
        """
        ref = coo_matrix(([1.0, 0.5], ([0, 1], [0, 1])), shape=(2, 2)).tocsr()
        coo = ref.tocoo()
        ...
        def mock_bcast(arr: np.ndarray, root: int = 0) -> None:
            """
    ...
    def test_rank1_receives_cell_of_element(
        self: "TestBroadcastWeightsInMemory",
    ) -> None:
        """
...
class TestRemapDatasetErrors:
    ...
    def test_remap_dataset_raises_without_weights(
        self: "TestRemapDatasetErrors",
    ) -> None:
        """
...
class TestUnstructuredToStructuredGridDataArray:
    ...
    def test_dataarray_input_preserves_attrs(
        self: "TestUnstructuredToStructuredGridDataArray",
    ) -> None:
        """
...
class TestEstimateMemoryUsage:
    ...
    def test_returns_sum_of_weight_and_data_memory(
        self: "TestEstimateMemoryUsage",
    ) -> None:
        """
...
class TestBuildEsmPyMeshFanTriangulation:
    ...
    def test_hexagonal_cells_fan_triangulated(
        self: "TestBuildEsmPyMeshFanTriangulation",
    ) -> None:
        """
...
class TestRemapMpasToLatlonErrors:
    ...
    def test_missing_scipy_raises_import_error(
        self: "TestRemapMpasToLatlonErrors",
    ) -> None:
        """
        ...
        lat = np.array([0.0, 30.0, 60.0])
        with patch.dict(
            sys.modules, {"scipy.spatial": None, "scipy.interpolate": None}
        ):
...
class TestBuildRemappedValidMaskPaths:
    ...
    def test_numpy_array_input_returns_mask(
        self: "TestBuildRemappedValidMaskPaths",
    ) -> None:
        """
    ...
    def test_scipy_import_error_returns_none(
        self: "TestBuildRemappedValidMaskPaths",
    ) -> None:
        """
        ...
        with patch.dict(sys.modules, {"scipy.spatial": None, "matplotlib.path": None}):
            result = build_remapped_valid_mask(
                lon_vals,
                lat_vals,
                lon_min=-10.0,
    ...
    def test_convex_hull_exception_returns_none(
        self: "TestBuildRemappedValidMaskPaths",
    ) -> None:
        """
...
class TestExtractCellCoordinatesError:
    ...
    def test_raises_when_no_coords_found(
        self: "TestExtractCellCoordinatesError",
    ) -> None:
        """
...
class TestApplyLonConvention:
    ...
    def test_zero_to_360_convention_shifts_negative_lons(
        self: "TestApplyLonConvention",
    ) -> None:
        """
    ...
    def test_auto_maps_global_0_360_source_to_signed_target(
        self: "TestApplyLonConvention",
    ) -> None:
        """
    ...
    def test_auto_resolves_to_0_360_for_wide_positive_target(
        self: "TestApplyLonConvention",
    ) -> None:
        """
        ...
        result = _apply_lon_convention(
            lon_coords, 135.0, lon_min=0.0, lon_max=360.0, lon_convention="auto"
        )
...
class TestDispatchRemapErrors:
    ...
    def test_esmf_engine_raises_when_esmpy_unavailable(
        self: "TestDispatchRemapErrors",
    ) -> None:
        """
