...
class TestLoad3DData:
    ...
    def test_load_with_xarray(self: "TestLoad3DData") -> None:
        ...
        result = processor.load_3d_data(
            str(self.paths["mpasout_dir"]), use_pure_xarray=True
        )
    ...
    def test_load_with_uxarray(self: "TestLoad3DData") -> None:
        ...
        result = processor.load_3d_data(
            str(self.paths["mpasout_dir"]), use_pure_xarray=False
        )
...
class TestGet3DVariableData:
    ...
    def _create_mock_dataset_with_pressure(self: "TestGet3DVariableData") -> Any:
        ...
        mock_ds.__getitem__.side_effect = make_getitem(
            {
                "pressure_base": mock_pressure_base,
                "pressure_p": mock_pressure_p,
                "theta": mock_theta,
            }
        )
