...
class TestParseArgsToConfig:
    ...
    def test_parse_args_with_figure_size(self: "TestParseArgsToConfig") -> None:
        ...
        """
        args = argparse.Namespace(
            figure_size=[12.0, 8.0], grid_file="grid.nc", data_dir="./data"
        )
    ...
    def test_parse_args_with_xarray_data_type(self: "TestParseArgsToConfig") -> None:
        ...
        """
        args = argparse.Namespace(
            data_type="xarray", grid_file="grid.nc", data_dir="./data"
        )
    ...
    def test_parse_args_with_uxarray_data_type(self: "TestParseArgsToConfig") -> None:
        ...
        """
        args = argparse.Namespace(
            data_type="uxarray", grid_file="grid.nc", data_dir="./data"
        )
...
class TestCreateSurfaceParser:
    ...
    def test_create_surface_parser_returns_parser(
        self: "TestCreateSurfaceParser",
    ) -> None:
        """
    ...
    def test_create_surface_parser_required_args(
        self: "TestCreateSurfaceParser",
    ) -> None:
        """
        ...
        args = parser.parse_args(
            ["--grid-file", "grid.nc", "--data-dir", "./data", "--variable", "t2m"]
        )
    ...
    def test_create_surface_parser_optional_args(
        self: "TestCreateSurfaceParser",
    ) -> None:
        """
...
class TestParseSurfaceArgsToConfig:
    ...
    def test_parse_surface_args_with_batch_all(
    ...
    def test_parse_surface_args_default_plot_type(
        self: "TestParseSurfaceArgsToConfig",
    ) -> None:
        """
    ...
    def test_parse_surface_args_default_time_index(
        self: "TestParseSurfaceArgsToConfig",
    ) -> None:
        """
...
class TestCreateWindParser:
    ...
    def test_create_wind_parser_defaults(self: "TestCreateWindParser") -> None:
        ...
        args = parser.parse_args(["--grid_file", "grid.nc", "--data_dir", "./data"])
...
class TestCreateCrosssectionParser:
    ...
    def test_create_crosssection_parser_returns_parser(
        self: "TestCreateCrosssectionParser",
    ) -> None:
        """
    ...
    def test_create_crosssection_parser_required_args(
        self: "TestCreateCrosssectionParser",
    ) -> None:
        """
    ...
    def test_create_crosssection_parser_defaults(
        self: "TestCreateCrosssectionParser",
    ) -> None:
        """
    ...
    def test_create_crosssection_parser_custom_args(
        self: "TestCreateCrosssectionParser",
    ) -> None:
        """
...
class TestParseCrosssectionArgsToConfig:
    ...
    def test_parse_crosssection_args_basic(
        self: "TestParseCrosssectionArgsToConfig",
    ) -> None:
        """
    ...
    def test_parse_crosssection_args_with_levels(
        self: "TestParseCrosssectionArgsToConfig",
    ) -> None:
        """
    ...
    def test_parse_crosssection_args_without_max_height(
        self: "TestParseCrosssectionArgsToConfig",
    ) -> None:
        """
...
class TestRemapEngineMethodCLIArgs:
    ...
    def test_parse_args_to_config_maps_remap_fields(
        self: "TestRemapEngineMethodCLIArgs",
    ) -> None:
        """
