...
class TestConvertDataForDisplayPressureBranch:
    ...
    def _make_pa_dataarray(
        self: "TestConvertDataForDisplayPressureBranch", var_name: str
    ) -> xr.DataArray:
        """
    ...
    def test_pressure_var_converts_pa_to_hpa(
        self: "TestConvertDataForDisplayPressureBranch",
    ) -> None:
        """
    ...
    def test_pressure_var_name_pressure_also_converts(
        self: "TestConvertDataForDisplayPressureBranch",
    ) -> None:
        """
...
class TestConvertDataForDisplayValueErrorFallback:
    ...
    def test_unsupported_conversion_falls_back_to_original_unit(
        self: "TestConvertDataForDisplayValueErrorFallback",
    ) -> None:
        """
