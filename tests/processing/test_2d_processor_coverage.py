...
class TestLoad2DDataUXarrayPath:
    ...
    def test_uxarray_path_assigns_dataset_and_returns_self(
        self: "TestLoad2DDataUXarrayPath", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        with patch.object(mock_proc, "_load_data", return_value=(mock_ux, "uxarray")):
            with patch.object(
                mock_proc, "add_spatial_coordinates", return_value=enriched_ds
            ):
...
class TestFindDiagFilesRecursive:
    ...
    def test_returns_sorted_list_when_two_or_more_found(
        self: "TestFindDiagFilesRecursive", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake_files = [
            str(tmp_path / "diag_2025.nc"),
            str(tmp_path / "diag_2024.nc"),
        ]  # intentionally unsorted
        with patch(
            "mpasdiag.processing.processors_2d.glob.glob", return_value=fake_files
        ):
            result = mock_proc._find_diag_files_recursive(str(tmp_path / "data"))
        assert result == sorted(fake_files)

    def test_verbose_prints_recursive_search_summary(
        self: "TestFindDiagFilesRecursive", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
    ...
    def test_returns_none_when_fewer_than_two_files(
        self: "TestFindDiagFilesRecursive", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        with patch(
            "mpasdiag.processing.processors_2d.glob.glob",
            return_value=[str(tmp_path / "diag_2024.nc")],
        ):
            result = mock_proc._find_diag_files_recursive(str(tmp_path / "data"))
        assert result is None

    def test_returns_none_when_no_files_found(
        self: "TestFindDiagFilesRecursive", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
...
class TestFindMpasoutFilesFallback:
    ...
    def test_returns_files_when_pattern_finder_succeeds(
        self: "TestFindMpasoutFilesFallback",
        ...
        """
        fake_files = [
            str(tmp_path / "mpasout_2024.nc"),
            str(tmp_path / "mpasout_2025.nc"),
        ]
    ...
    def test_raises_file_not_found_when_no_files_anywhere(
        self: "TestFindMpasoutFilesFallback",
        mock_proc: "MPAS2DProcessor",
        tmp_path: Path,
    ) -> None:
    ...
    def test_returns_files_from_recursive_search_verbose(
        self: "TestFindMpasoutFilesFallback",
        mock_proc: "MPAS2DProcessor",
        tmp_path: Path,
    ) -> None:
        ...
        with patch.object(
            ...
            with patch(
                ...
                captured = StringIO()
                with patch("sys.stdout", new=captured):
                    result = mock_proc._find_mpasout_files_fallback(
                        str(tmp_path / "data")
                    )
    ...
    def test_returns_files_from_recursive_search_silent(
        self: "TestFindMpasoutFilesFallback",
        mock_proc: "MPAS2DProcessor",
        tmp_path: Path,
    ) -> None:
...
class TestFindDiagnosticFiles:
    ...
    def test_finds_files_in_main_directory(
        self: "TestFindDiagnosticFiles", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake_files = [
            str(tmp_path / "data" / "diag_2024.nc"),
            str(tmp_path / "data" / "diag_2025.nc"),
        ]
    ...
    def test_finds_files_in_diag_subdir_when_main_dir_fails(
        self: "TestFindDiagnosticFiles", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake_files = [
            str(tmp_path / "data" / "diag" / "diag_2024.nc"),
            str(tmp_path / "data" / "diag" / "diag_2025.nc"),
        ]
    ...
    def test_falls_back_to_recursive_search(
        ...
        """
        fake_files = [
            str(tmp_path / "data" / "sub" / "diag_2024.nc"),
            str(tmp_path / "data" / "sub" / "diag_2025.nc"),
        ]
        ...
        with patch.object(
            ...
            with patch.object(
                mock_proc, "_find_diag_files_recursive", return_value=fake_files
            ):
                result = mock_proc.find_diagnostic_files(str(tmp_path / "data"))

        assert result == fake_files

    def test_falls_back_to_mpasout_when_recursive_returns_none(
        self: "TestFindDiagnosticFiles", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
        ...
        """
        fake_files = [
            str(tmp_path / "data" / "mpasout_2024.nc"),
            str(tmp_path / "data" / "mpasout_2025.nc"),
        ]
        ...
        with patch.object(
            ...
            with patch.object(
                mock_proc, "_find_diag_files_recursive", return_value=None
            ):
                with patch.object(
                    mock_proc, "_find_mpasout_files_fallback", return_value=fake_files
                ):
                    result = mock_proc.find_diagnostic_files(str(tmp_path / "data"))

        assert result == fake_files

    def test_verbose_prints_no_diag_files_message_before_mpasout_fallback(
        self: "TestFindDiagnosticFiles", mock_proc: "MPAS2DProcessor", tmp_path: Path
    ) -> None:
        """
...
class TestLookup2DCoord:
    ...
    def test_returns_none_when_no_matching_name_found(
        self: "TestLookup2DCoord", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_returns_array_for_first_matching_coord_name(
        self: "TestLookup2DCoord", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_falls_through_to_second_name_when_first_absent(
        self: "TestLookup2DCoord", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
...
class TestExtract2DCoordinatesForVariable:
    ...
    def test_raises_when_dataset_is_none(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_raises_when_lon_lat_coords_not_found(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_degree_coords_returned_correctly(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_vertex_dimension_selects_vertex_coord_names(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_verbose_prints_extracted_coord_message(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_data_array_sizes_override_var_name_lookup(
        self: "TestExtract2DCoordinatesForVariable", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
...
class TestLog2DVariableRange:
    ...
    def test_verbose_false_produces_no_output(
        self: "TestLog2DVariableRange", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_all_nan_prints_no_finite_values_warning(
        self: "TestLog2DVariableRange", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_finite_values_print_range_info(
        self: "TestLog2DVariableRange", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_finite_values_with_units_attr_prints_units(
        self: "TestLog2DVariableRange", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
...
class TestGet2DVariableData:
    ...
    def test_raises_when_dataset_is_none(
        self: "TestGet2DVariableData", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_raises_when_variable_not_in_dataset(
        self: "TestGet2DVariableData", loaded_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_returns_correct_time_slice_shape(
        self: "TestGet2DVariableData", loaded_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_verbose_prints_extraction_message(
        self: "TestGet2DVariableData", loaded_proc: "MPAS2DProcessor"
    ) -> None:
        """
    ...
    def test_uxarray_path_uses_positional_index(
        self: "TestGet2DVariableData", mock_proc: "MPAS2DProcessor"
    ) -> None:
        """
