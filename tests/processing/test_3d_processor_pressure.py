...
class TestGet3DVariableDataPressureInterpolation:
    ...
    def test_pressure_interpolation_with_synthetic_pressure_components(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
        ...
        if "pressure" in processor.dataset:
            ...
            var_data = processor.get_3d_variable_data(
                "theta", level=85000.0, time_index=0
            )
            ...
            var_data_high = processor.get_3d_variable_data(
                "theta", level=120000.0, time_index=0
            )
            ...
            var_data_low = processor.get_3d_variable_data(
                "theta", level=100.0, time_index=0
            )
    ...
    def test_pressure_interpolation_with_pressure_data(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
    ...
    def test_pressure_level_above_surface_fallback(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
    ...
    def test_pressure_level_below_top_fallback(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
        ...
        top_level = nlevels - 1
        var_data = processor.get_3d_variable_data(
            "theta", level=top_level, time_index=0
        )
    ...
    def test_pressure_interpolation_weight_calculation(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
        ...
        mid_level = nlevels // 2
        var_data = processor.get_3d_variable_data(
            "theta", level=mid_level, time_index=0
        )
    ...
    def test_pressure_interpolation_equal_pressures(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
    ...
    def test_pressure_interpolation_multiple_levels(
        self: "TestGet3DVariableDataPressureInterpolation",
    ) -> None:
        """
        ...
        for level in test_levels:
            var_data = processor.get_3d_variable_data(
                "theta", level=level, time_index=0
            )
            assert var_data is not None
            assert hasattr(var_data, "values")
            assert var_data.values.size > 0
...
class TestGet3DVariableDataAttributes:
    ...
    def test_attributes_with_pressure_level(
        self: "TestGet3DVariableDataAttributes",
    ) -> None:
        """
    ...
    def test_warning_for_no_finite_values(
        self: "TestGet3DVariableDataAttributes",
    ) -> None:
        """
...
class TestGetVerticalLevelsEdgeCases:
    ...
    def test_pressure_from_pressure_variable_non_positive_warning(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
        ...
        mock_ds.__getitem__.side_effect = make_getitem(
            {"pressure": mock_pressure}, default=mock_var
        )
        ...
        levels = processor.get_vertical_levels(
            "theta", return_pressure=True, time_index=0
        )
    ...
    def test_pressure_from_components_n_vert_levels_p1_extension(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
        ...
        for var_name in processor.get_available_3d_variables():
            if "nVertLevelsP1" in processor.dataset[var_name].sizes:
                levels = processor.get_vertical_levels(
                    var_name, return_pressure=True, time_index=0
                )
                assert isinstance(levels, list)
                break

    def test_pressure_from_hybrid_coords_interpolation(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
        ...
        mock_ds.__getitem__.side_effect = make_getitem(
            {"fzp": mock_fzp, "surface_pressure": mock_sp}, default=mock_var
        )
        mock_ds.__contains__.side_effect = make_contains(
            ["theta", "fzp", "surface_pressure"]
        )
    ...
    def test_pressure_from_hybrid_coords_single_good_value(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
    ...
    def test_pressure_from_hybrid_coords_no_good_values(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
    ...
    def test_pressure_from_hybrid_coords_exception_fallback(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
        ...
        mock_ds.__getitem__.side_effect = make_getitem_with_raise(
            "fzp", RuntimeError("Failed to access fzp"), default=mock_var
        )
        mock_ds.__contains__.side_effect = make_contains(
            ["theta", "fzp", "surface_pressure"]
        )
    ...
    def test_model_level_indices_verbose(
        self: "TestGetVerticalLevelsEdgeCases",
    ) -> None:
        """
        ...
        processor = load_mpas_3d_processor(verbose=True)
        levels = processor.get_vertical_levels(
            "theta", return_pressure=False, time_index=0
        )
