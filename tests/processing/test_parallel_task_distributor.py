...
class TestMPASTaskDistributor:
    ...
    def test_distribute_tasks_dynamic_strategy(
        self: "TestMPASTaskDistributor",
    ...
    def test_distribute_tasks_block_strategy(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
        tasks_9: List[int],
    ) -> None:
        ...
        assert task_ids == list(
            range(len(task_ids))
        ), "Block distribution must be contiguous from 0"

    def test_distribute_tasks_cyclic_strategy(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
        tasks_9: List[int],
    ) -> None:
    ...
    def test_distribute_tasks_dynamic_matches_static(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
        tasks_9: List[int],
    ) -> None:
    ...
    def test_distribute_tasks_else_fallback(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
        tasks_9: List[int],
    ) -> None:
    ...
    def test_block_distribution_direct(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
    ) -> None:
        """
    ...
    def test_cyclic_distribution_direct(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
    ) -> None:
        """
    ...
    def test_dynamic_distribution_direct(
        self: "TestMPASTaskDistributor",
        mock_comm_rank0: Mock,
        tasks_9: List[int],
    ) -> None:
        ...
        """
        distributor = MPASTaskDistributor(mock_comm_rank0, LoadBalanceStrategy.DYNAMIC)
        assert distributor._dynamic_distribution(
            tasks_9
        ) == distributor._static_distribution(tasks_9)
