...
class TestParseFileDatetimes:
    ...
    def test_no_match_silent_generates_synthetic(
        self: "TestParseFileDatetimes",
    ) -> None:
        """
    ...
    def test_invalid_datetime_match_silent_fallback(
        self: "TestParseFileDatetimes",
    ) -> None:
        """
    ...
    def test_invalid_datetime_match_verbose_prints_warning(
        self: "TestParseFileDatetimes",
    ) -> None:
        """
...
class TestValidateTimeParameters:
    ...
    def test_valid_index_returns_correct_tuple(
        self: "TestValidateTimeParameters", time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_out_of_range_index_clamped_silent(
        self: "TestValidateTimeParameters", time_dataset: xr.Dataset
    ) -> None:
        """
        ...
        Returns:
            None
        """
        _, idx, size = MPASDateTimeUtils.validate_time_parameters(
            time_dataset, 99, verbose=False
        )
        assert idx == size - 1

    def test_out_of_range_index_clamped_verbose(
        self: "TestValidateTimeParameters", time_dataset: xr.Dataset
    ) -> None:
        """
        ...
        with patch("sys.stdout", new=captured):
            _, idx, size = MPASDateTimeUtils.validate_time_parameters(
                time_dataset, 99, verbose=True
            )
        assert idx == size - 1
        assert "exceeds" in captured.getvalue()

    def test_lowercase_time_dim_used(
        self: "TestValidateTimeParameters", lowercase_time_dataset: xr.Dataset
    ) -> None:
        """
        ...
        Returns:
            None
        """
        dim, _, size = MPASDateTimeUtils.validate_time_parameters(
            lowercase_time_dataset, 0
        )
        assert dim == "time"
        assert size == 3
...
class TestExtractTimeStr:
    ...
    def test_no_time_attr_returns_none(
        self: "TestExtractTimeStr", no_time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_time_index_out_of_range_returns_none(
        self: "TestExtractTimeStr", time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_numpy_datetime64_uses_pd_to_datetime(
        self: "TestExtractTimeStr", time_dataset: xr.Dataset
    ) -> None:
        """
        ...
        assert not hasattr(
            time_val, "strftime"
        ), "Fixture must contain numpy datetime64"
...
class TestLogTimeInfo:
    ...
    def test_error_present_no_context(self: "TestLogTimeInfo") -> None:
        ...
        captured = StringIO()
        with patch("sys.stdout", new=captured):
            MPASDateTimeUtils._log_time_info(
                True, 2, None, "", error=RuntimeError("oops")
            )
        output = captured.getvalue()
    ...
    def test_error_present_with_context(self: "TestLogTimeInfo") -> None:
        ...
        with patch("sys.stdout", new=captured):
            MPASDateTimeUtils._log_time_info(
                True, 2, None, "wind", error=RuntimeError("oops")
            )
        output = captured.getvalue()
...
class TestGetTimeInfo:
    ...
    def test_exception_in_extract_returns_fallback(
        self: "TestGetTimeInfo", time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_exception_in_extract_verbose_logs_error(
        self: "TestGetTimeInfo", time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_valid_dataset_returns_time_string(
        self: "TestGetTimeInfo", time_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_no_time_coord_returns_fallback(
        self: "TestGetTimeInfo", no_time_dataset: xr.Dataset
    ) -> None:
        """
...
class TestGetTimeRange:
    ...
    def test_valid_dataset_returns_start_end(
        self: "TestGetTimeRange", time_dataset: xr.Dataset
    ) -> None:
        """
...
class TestFormatTimeForFilename:
    ...
    def test_mpas_format(self: "TestFormatTimeForFilename") -> None:
        ...
        """
        assert (
            MPASDateTimeUtils.format_time_for_filename(self.dt, "mpas")
            == "2024-01-15_06.30.45"
        )
    ...
    def test_iso_format(self: "TestFormatTimeForFilename") -> None:
        ...
        """
        assert (
            MPASDateTimeUtils.format_time_for_filename(self.dt, "iso")
            == "20240115T063045"
        )
    ...
    def test_compact_format(self: "TestFormatTimeForFilename") -> None:
        ...
        """
        assert (
            MPASDateTimeUtils.format_time_for_filename(self.dt, "compact")
            == "2024011506"
        )
...
class TestParseTimeFromString:
    ...
    def test_default_patterns_iso_compact_format(
        self: "TestParseTimeFromString",
    ) -> None:
        """
...
class TestGetTimeBounds:
    ...
    def test_no_bounds_variable_returns_none_none(
        self: "TestGetTimeBounds", time_dataset: xr.Dataset
    ) -> None:
        """
...
class TestCalculateTimeDelta:
    ...
    def test_valid_dataset_returns_correct_timedelta(
        self: "TestCalculateTimeDelta",
    ) -> None:
        """
