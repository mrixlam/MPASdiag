...
class TestComputePrecipitationDifference:
    ...
    @pytest.fixture
    def sample_dataset(
        self: "TestComputePrecipitationDifference", mpas_2d_processor_diag: Any
    ) -> Any:
        """
    ...
    def test_compute_difference_basic(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
    ...
    def test_compute_difference_verbose(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
    ...
    def test_compute_difference_total_precipitation(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
    ...
    def test_compute_difference_all_accumulation_periods(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
    ...
    def test_compute_difference_time_index_zero(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
    ...
    def test_compute_difference_insufficient_lookback(
        self: "TestComputePrecipitationDifference", sample_dataset: Any
    ) -> None:
        """
...
class TestPrecipitationTimeMetadata:
    ...
    @staticmethod
    def _make_dataset(n_time: int = 4, n_cells: int = 6) -> xr.Dataset:
        """
    ...
    def test_valid_time_and_window_start_attached(
        self: "TestPrecipitationTimeMetadata",
    ) -> None:
        """
        ...
        assert (
            result.attrs["accumulation_start_time"]
            == pd.Timestamp(times[1]).isoformat()
        )

    def test_window_start_tracks_accumulation_period(
        self: "TestPrecipitationTimeMetadata",
    ) -> None:
        """
    ...
    def test_first_time_step_has_valid_time_without_window_start(
        self: "TestPrecipitationTimeMetadata",
    ) -> None:
        """
