...
def _synthetic_mpas_data(
    ...
    nan_pressure_idx: Optional[int] = None,
) -> xr.Dataset:
    """
...
class TestThermodynamicIndicesWithWindAndHeight:
    ...
    def test_wet_bulb_zero_path_executed(
        self: "TestThermodynamicIndicesWithWindAndHeight",
    ) -> None:
        """
    ...
    def test_shear_indices_attempted_with_wind_height(
        self: "TestThermodynamicIndicesWithWindAndHeight",
    ) -> None:
        """
