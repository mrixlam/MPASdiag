...
class _FakeCtxMgr:
    ...
    def __init__(self: "_FakeCtxMgr", ds: xr.Dataset) -> None:
        """
...
class TestComputeThermodynamicIndicesNoMetPy:
    ...
    def test_no_metpy_returns_result_with_fallback_lcl(
        self: "TestComputeThermodynamicIndicesNoMetPy",
    ) -> None:
        """
    ...
    def test_no_metpy_verbose_prints_message(
        self: "TestComputeThermodynamicIndicesNoMetPy",
    ) -> None:
        """
...
class TestComputeThermodynamicIndicesMetPyFails:
    ...
    def test_parcel_profile_failure_returns_empty_result(
        self: "TestComputeThermodynamicIndicesMetPyFails",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.parcel_profile",
    ...
    def test_parcel_profile_failure_verbose_prints(
        self: "TestComputeThermodynamicIndicesMetPyFails",
    ) -> None:
        """
...
class TestSbcapeFallback:
    ...
    def test_sbcape_fallback_triggers_cape_cin(self: "TestSbcapeFallback") -> None:
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.surface_based_cape_cin",
...
class TestLoadGridCoordinatesProbeFailure:
    ...
    def test_probe_exception_falls_through_to_main_open(
        self: "TestLoadGridCoordinatesProbeFailure", tmp_path: Path
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.xr.open_dataset",
...
class TestLoadGridCoordinatesNoLon:
    ...
    def test_missing_lon_raises(
        self: "TestLoadGridCoordinatesNoLon", tmp_path: Path
    ) -> None:
        """
...
class TestLoadGridCoordinatesNoLat:
    ...
    def test_missing_lat_raises(
        self: "TestLoadGridCoordinatesNoLat", tmp_path: Path
    ) -> None:
        """
...
class TestSafePairToUnit:
    ...
    def test_to_unit_converts_before_extracting_magnitude(
        self: "TestSafePairToUnit",
    ) -> None:
        """
...
class TestComputeFallbackLcl:
    ...
    def test_fallback_lcl_verbose_prints_skip_message(
        self: "TestComputeFallbackLcl",
    ) -> None:
        """
    ...
    def test_fallback_lcl_empty_arrays_handled_gracefully(
        self: "TestComputeFallbackLcl",
    ) -> None:
        """
...
class TestComputeWetBulbZeroException:
    ...
    def test_wet_bulb_exception_returns_none(
        self: "TestComputeWetBulbZeroException",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.wet_bulb_temperature",
            side_effect=RuntimeError("wb fail"),
        ):
            result = SoundingDiagnostics._compute_wet_bulb_zero(
                p_metpy, t_metpy, td_metpy, h
            )

        assert result is None

    def test_wet_bulb_no_units_returns_none(
        self: "TestComputeWetBulbZeroException",
    ) -> None:
        """
...
class TestComputeShearIndicesExceptions:
    ...
    def _base_result_with_deps(self: "TestComputeShearIndicesExceptions") -> dict:
        ...
        """
        return {
            "bulk_shear_0_1km": 20.0,
            "bulk_shear_0_6km": 30.0,
            "srh_0_1km": 200.0,
            "srh_0_3km": 300.0,
            "sbcape": 1000.0,
            "lcl_pressure": 900.0,
    ...
    def test_wind_unit_setup_fails_returns_early(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
    ...
    def test_bulk_shear_exception_is_silenced(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.bulk_shear",
    ...
    def test_srh_exception_is_silenced(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.storm_relative_helicity",
    ...
    def test_stp_exception_is_silenced(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.significant_tornado",
    ...
    def test_scp_exception_is_silenced(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.supercell_composite",
    ...
    def test_sweat_exception_is_silenced(
        self: "TestComputeShearIndicesExceptions",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.diagnostics.sounding.mpcalc.sweat_index",
...
class TestExtractPressureProfileNoPressureVars:
    ...
    def test_no_pressure_vars_raises(
        self: "TestExtractPressureProfileNoPressureVars",
    ) -> None:
        """
...
class TestExtractTemperatureProfileNoTempVars:
    ...
    def test_no_temp_vars_raises(
        self: "TestExtractTemperatureProfileNoTempVars",
    ) -> None:
        """
...
class TestExtractDewpointNoMoistureVar:
    ...
    def test_no_moisture_verbose_prints_warning(
        self: "TestExtractDewpointNoMoistureVar",
    ) -> None:
        """
    ...
    def test_no_moisture_silent_when_not_verbose(
        self: "TestExtractDewpointNoMoistureVar",
    ) -> None:
        """
...
class TestExtractWindProfilesNoVars:
    ...
    def test_no_wind_vars_verbose_prints_warning(
        self: "TestExtractWindProfilesNoVars",
    ) -> None:
        """
    ...
    def test_no_wind_vars_silent_when_not_verbose(
        self: "TestExtractWindProfilesNoVars",
    ) -> None:
        """
...
class TestExtractHeightStaggered:
    ...
    def test_staggered_height_averaged_to_nvert_levels(
        self: "TestExtractHeightStaggered",
    ) -> None:
        """
...
class TestExtractHeightException:
    ...
    def test_isel_exception_continues_and_returns_none(
        self: "TestExtractHeightException",
    ) -> None:
        """
    ...
    def test_isel_exception_verbose_prints_warning(
        self: "TestExtractHeightException",
    ) -> None:
        """
