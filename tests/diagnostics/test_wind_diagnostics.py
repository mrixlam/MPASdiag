...
class TestWindDiagnostics:
    ...
    def test_analyze_wind_components(
        self: "TestWindDiagnostics", mock_mpas_2d_data: xr.Dataset
    ) -> None:
        """
...
class TestAnalyzeWindComponents:
    ...
    def sample_wind_components(self: "TestAnalyzeWindComponents") -> Any:
        ...
        """
        u = xr.DataArray(
            _RNG.standard_normal(100) * 5, dims=["nCells"], attrs={"units": "m s^{-1}"}
        )
    ...
    def test_analyze_wind_components_2d(
        self: "TestAnalyzeWindComponents", sample_wind_components: Any
    ) -> None:
        """
    ...
    def test_analyze_wind_components_3d(
        self: "TestAnalyzeWindComponents", sample_wind_components: Any
    ) -> None:
        """
    ...
    def test_analyze_wind_components_verbose_2d(
        self: "TestAnalyzeWindComponents", sample_wind_components: Any
    ) -> None:
        """
    ...
    def test_analyze_wind_components_verbose_3d(
        self: "TestAnalyzeWindComponents", sample_wind_components: Any
    ) -> None:
        """
...
class TestComputeWindShear:
    ...
    def sample_wind_levels(self: "TestComputeWindShear") -> Any:
        ...
        """
        u_upper = xr.DataArray(np.array([10.0, 15.0, 20.0]), dims=["nCells"])

        v_upper = xr.DataArray(np.array([5.0, 10.0, 15.0]), dims=["nCells"])

        u_lower = xr.DataArray(np.array([5.0, 10.0, 15.0]), dims=["nCells"])

        v_lower = xr.DataArray(np.array([2.0, 5.0, 10.0]), dims=["nCells"])

        return u_upper, v_upper, u_lower, v_lower

    def test_compute_wind_shear_verbose(
        self: "TestComputeWindShear", sample_wind_levels: Any
    ) -> None:
        """
        ...
        with patch("sys.stdout", captured_output):
            _, _ = diag.compute_wind_shear(u_upper, v_upper, u_lower, v_lower)
...
class TestGet3DWindComponents:
    ...
    def test_get_3d_wind_components_model_level(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_pressure_level(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_surface(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_top(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_missing_w(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_verbose(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
    ...
    def test_get_3d_wind_components_uxarray(
        self: "TestGet3DWindComponents", sample_3d_dataset: xr.Dataset
    ) -> None:
        """
...
class TestGet2DWindComponents:
    ...
    def test_get_2d_wind_components_unit_mismatch(
        self: "TestGet2DWindComponents",
    ) -> None:
        """
...
class TestEdgeCasesAndErrorPaths:
    ...
    def test_get_3d_wind_components_missing_v_variable_error_path(
        self: "TestEdgeCasesAndErrorPaths",
    ) -> None:
        """
        ...
        dataset = xr.Dataset(
            {
                "u": (
                    ...
                    _RNG.standard_normal((n_time, n_vert_levels, n_cells)),
                ),
        ...
        with pytest.raises(
            ValueError, match="3D wind variables \\['v', 'w'\\] not found"
        ):
