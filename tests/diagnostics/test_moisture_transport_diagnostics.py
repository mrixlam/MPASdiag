...
class TestMoistureTransportDiagnostics:
    ...
    def test_analyze_moisture_transport_keys(
        self: "TestMoistureTransportDiagnostics",
        synthetic_3d_data: Dict[str, xr.DataArray],
    ) -> None:
        """
    ...
    def test_analyze_moisture_transport_data_arrays(
        self: "TestMoistureTransportDiagnostics",
        synthetic_3d_data: Dict[str, xr.DataArray],
    ) -> None:
        """
        ...
        for key in result:
            ...
            assert isinstance(
                arr, xr.DataArray
            ), f"'data' for '{key}' is not a DataArray."
            assert "nVertLevels" not in arr.dims

    def test_analyze_moisture_transport_verbose(
        self: "TestMoistureTransportDiagnostics",
        synthetic_3d_data: Dict[str, xr.DataArray],
    ) -> None:
        """
    ...
    def test_analyze_moisture_transport_consistency(
        self: "TestMoistureTransportDiagnostics",
        synthetic_3d_data: Dict[str, xr.DataArray],
    ) -> None:
        """
    ...
    def test_analyze_moisture_transport_with_real_data(
        self: "TestMoistureTransportDiagnostics", mock_mpas_3d_data: xr.Dataset
    ) -> None:
        """
