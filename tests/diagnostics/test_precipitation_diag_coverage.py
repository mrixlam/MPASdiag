...
class TestGetAccumulationHours:
    ...
    def test_unknown_period_defaults_to_24(
        self: "TestGetAccumulationHours", diag: "PrecipitationDiagnostics"
    ) -> None:
        """
...
class TestComputePrecipitationDifference:
    ...
    def test_none_dataset_raises(
        self: "TestComputePrecipitationDifference", diag: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_normal_accumulation_rainnc(
        self: "TestComputePrecipitationDifference",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_total_variable_silent(
        self: "TestComputePrecipitationDifference",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_total_variable_verbose_triggers_diagnostic(
        self: "TestComputePrecipitationDifference",
        ...
        with patch("sys.stdout", new=captured):
            result = diag_v.compute_precipitation_difference(
                precip_ds, 3, "total", "a01h"
            )

        assert isinstance(result, xr.DataArray)
        assert (
            "range" in captured.getvalue().lower() or "Computing" in captured.getvalue()
        )

    def test_time_index_zero_returns_data(
        self: "TestComputePrecipitationDifference",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_insufficient_lookback_returns_zero_field(
        self: "TestComputePrecipitationDifference",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_verbose_mode_prints_output(
        self: "TestComputePrecipitationDifference",
        diag_v: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
...
class TestExtractVariableAtTime:
    ...
    def test_xarray_path(
        self: "TestExtractVariableAtTime",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
        """
        ...
        Returns:
            None
        """
        result = diag._extract_variable_at_time(
            precip_ds, "rainnc", 2, "Time", "xarray"
        )
        assert isinstance(result, xr.DataArray)
        assert result.shape == (50,)

    def test_uxarray_path(
        self: "TestExtractVariableAtTime",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
        ...
        """
        result = diag._extract_variable_at_time(
            precip_ds, "rainnc", 2, "Time", "uxarray"
        )
        assert isinstance(result, xr.DataArray)
...
class TestExtractSampleDataForVariable:
    ...
    def test_total_sums_rainc_and_rainnc(
        self: "TestExtractSampleDataForVariable",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
        """
        ...
        Returns:
            None
        """
        result = diag._extract_sample_data_for_variable(
            precip_ds, "total", 0, "Time", "xarray"
        )

        expected = precip_ds["rainc"].isel(Time=0) + precip_ds["rainnc"].isel(Time=0)

        assert np.allclose(result.values, expected.values)

    def test_single_variable_returned_directly(
        self: "TestExtractSampleDataForVariable",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
        ...
        """
        result = diag._extract_sample_data_for_variable(
            precip_ds, "rainnc", 0, "Time", "xarray"
        )
...
class TestHandleFirstTimeStep:
    ...
    def test_time_index_zero_verbose_prints_message(
        self: "TestHandleFirstTimeStep",
        diag_v: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
        """
        ...
        with patch("sys.stdout", new=captured):
            result = diag_v._handle_time_index_zero(
                precip_ds, "Time", "rainnc", "a01h", 1, "xarray"
            )

        assert "Time index 0" in captured.getvalue()
        assert isinstance(result, xr.DataArray)

    def test_insufficient_lookback_verbose(
        self: "TestHandleFirstTimeStep",
        diag_v: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_insufficient_lookback_silent(
        self: "TestHandleFirstTimeStep",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_exception_in_handle_first_time_step_raises_value_error(
        self: "TestHandleFirstTimeStep",
        diag: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_exception_in_handle_first_time_step_verbose_prints_error(
        self: "TestHandleFirstTimeStep",
        diag_v: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
...
class TestPrintCurrentPreviousComparison:
    ...
    def test_normal_comparison_no_warning(
        self: "TestPrintCurrentPreviousComparison", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_current_max_less_than_previous_prints_warning(
        self: "TestPrintCurrentPreviousComparison", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_exception_in_min_max_prints_error(
        self: "TestPrintCurrentPreviousComparison", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
...
class TestComputeResultStatistics:
    ...
    def test_normal_data_returns_dict(
        self: "TestComputeResultStatistics", diag: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_exception_returns_none_and_prints(
        self: "TestComputeResultStatistics", diag: "PrecipitationDiagnostics"
    ) -> None:
        """
...
class TestPrintResultDataAnalysis:
    ...
    def test_normal_data_prints_stats(
        self: "TestPrintResultDataAnalysis", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_all_nan_prints_warning_and_returns(
        self: "TestPrintResultDataAnalysis", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
...
class TestAnalyzePrecipitationDiagnostics:
    ...
    def test_verbose_false_returns_immediately(
        self: "TestAnalyzePrecipitationDiagnostics", diag: "PrecipitationDiagnostics"
    ) -> None:
        """
        ...
        with patch("sys.stdout", new=captured):
            diag._analyze_precipitation_diagnostics(
                current, current, result_data, "test"
            )

        assert captured.getvalue() == ""

    def test_with_current_and_previous_verbose(
        self: "TestAnalyzePrecipitationDiagnostics", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
        ...
        with patch("sys.stdout", new=captured):
            diag_v._analyze_precipitation_diagnostics(
                current, previous, var_context="rainnc"
            )

        assert len(captured.getvalue()) > 0

    def test_with_result_data_only_verbose(
        self: "TestAnalyzePrecipitationDiagnostics", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
        ...
        with patch("sys.stdout", new=captured):
            diag_v._analyze_precipitation_diagnostics(
                result_data=result_data, var_context="test"
            )
...
class TestPrintTimeSliceInfo:
    ...
    def test_with_time_coords_prints_info(
        self: "TestPrintTimeSliceInfo",
        diag_v: "PrecipitationDiagnostics",
        precip_ds: xr.Dataset,
    ) -> None:
    ...
    def test_without_time_coords_prints_index_info(
        self: "TestPrintTimeSliceInfo", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
    ...
    def test_exception_in_dims_access_prints_error(
        self: "TestPrintTimeSliceInfo", diag_v: "PrecipitationDiagnostics"
    ) -> None:
        """
...
class TestCreatePrecipitationFieldWithAttributes:
    ...
    def test_normal_field_has_correct_attrs(
        self: "TestCreatePrecipitationFieldWithAttributes",
        diag: "PrecipitationDiagnostics",
    ) -> None:
        """
    ...
    def test_insufficient_data_flag_adds_note(
        self: "TestCreatePrecipitationFieldWithAttributes",
        diag: "PrecipitationDiagnostics",
    ) -> None:
        """
