...
class TestComputeWindDirectionRadians:
    ...
    def test_radians_returns_dataarray_in_range(
        self: "TestComputeWindDirectionRadians", wind_pair: tuple
    ) -> None:
        """
    ...
    def test_radians_attrs_are_set(
        self: "TestComputeWindDirectionRadians", wind_pair: tuple
    ) -> None:
        """
    ...
    def test_radians_verbose_prints_range_and_mean(
        self: "TestComputeWindDirectionRadians", wind_pair: tuple
    ) -> None:
        """
    ...
    def test_radians_verbose_false_silent(
        self: "TestComputeWindDirectionRadians", wind_pair: tuple
    ) -> None:
        """
...
class TestComputeLevelIndexFromPressure:
    ...
    def test_missing_pressure_vars_raises(
        self: "TestComputeLevelIndexFromPressure", ds_3d_no_pressure: xr.Dataset
    ) -> None:
        """
    ...
    def test_missing_only_pressure_p_raises(
        self: "TestComputeLevelIndexFromPressure",
    ) -> None:
        """
    ...
    def test_verbose_prints_pressure_info(
        self: "TestComputeLevelIndexFromPressure", ds_3d: xr.Dataset
    ) -> None:
        """
...
class TestComputeLevelIndex:
    ...
    def test_int_level_exceeds_max_raises(
    ...
    def test_invalid_type_level_raises(
        self: "TestComputeLevelIndex", ds_3d: xr.Dataset
    ) -> None:
        """
...
class TestGet2DWindComponentsNoneDataset:
    ...
    def test_none_dataset_raises_runtimeerror(
        self: "TestGet2DWindComponentsNoneDataset",
    ) -> None:
        """
...
class TestGet2DWindComponentsMissingVars:
    ...
    def test_missing_u_variable_raises(
        self: "TestGet2DWindComponentsMissingVars",
    ) -> None:
        """
    ...
    def test_missing_v_variable_raises(
        self: "TestGet2DWindComponentsMissingVars",
    ) -> None:
        """
    ...
    def test_missing_both_variables_raises(
        self: "TestGet2DWindComponentsMissingVars",
    ) -> None:
        """
...
class TestGet2DWindComponentsUXarray:
    ...
    def test_uxarray_path_returns_dataarrays(
        self: "TestGet2DWindComponentsUXarray", ds_2d: xr.Dataset
    ) -> None:
        """
    ...
    def test_uxarray_path_verbose_prints(
        self: "TestGet2DWindComponentsUXarray", ds_2d: xr.Dataset
    ) -> None:
        """
...
class TestGet2DWindComponentsExceptions:
    ...
    def test_keyerror_inside_try_becomes_valueerror(
        self: "TestGet2DWindComponentsExceptions",
    ) -> None:
        """
    ...
    def test_generic_exception_inside_try_becomes_runtimeerror(
        self: "TestGet2DWindComponentsExceptions",
    ) -> None:
        """
        ...
        with patch(
            ...
            with pytest.raises(
                RuntimeError, match="Error extracting 2D wind components"
            ):
                diag.get_2d_wind_components(mock_ds, "u10", "v10", time_index=0)
