...
class _Raisable:
    ...
    def __mul__(self: "_Raisable", other: object) -> None:
        """
    ...
    def __rmul__(self: "_Raisable", other: object) -> None:
        """
        This method is intentionally designed to raise a RuntimeError whenever an instance of _Raisable is multiplied by any other object. This allows us to test the robustness of exception handling in the SoundingDiagnostics class when performing operations that involve multiplication, such as unit conversions or calculations of indices.
...
class TestLoadGridCoordinatesDropVariables:
    ...
    def test_drop_variables_set_when_extra_vars_present(
        ...
        ds = xr.Dataset(
            {
                "lonCell": (
                    ["nCells"],
                    np.radians(np.linspace(-110.0, -90.0, N_CELLS)),
                ),
...
class TestComputeShearOuterExcepts:
    ...
    def test_stp_outer_except_empty_height(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
    ...
    def test_stp_outer_except_also_silent_verbose(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
    ...
    def test_scp_outer_except_raisable_mucape(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
    ...
    def test_scp_outer_except_does_not_abort_sweat(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
    ...
    def test_sweat_outer_except_raisable_temperature(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
    ...
    def test_sweat_outer_except_raisable_temperature_verbose(
        self: "TestComputeShearOuterExcepts",
    ) -> None:
        """
