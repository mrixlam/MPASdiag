...
class TestPrecipitationDiagnosticsPipeline:
    ...
    def test_accumulation_difference_periods(
        self: "TestPrecipitationDiagnosticsPipeline",
    ...
    def test_first_timestep_edge_case(
        self: "TestPrecipitationDiagnosticsPipeline",
        real_2d_processor: MPAS2DProcessor,
    ) -> None:
        """
...
class TestWindDiagnosticsPipeline:
    ...
    def test_wind_speed_direction_and_analysis(
        self: "TestWindDiagnosticsPipeline",
        real_2d_processor: MPAS2DProcessor,
    ) -> None:
        """
...
class TestSoundingDiagnosticsPipeline:
    ...
    def test_extract_sounding_profile(
        self: "TestSoundingDiagnosticsPipeline",
    ...
    def test_dewpoint_from_mixing_ratio(
        self: "TestSoundingDiagnosticsPipeline",
    ) -> None:
        """
    ...
    def test_thermodynamic_indices_from_profile(
        self: "TestSoundingDiagnosticsPipeline",
        real_3d_processor: MPAS3DProcessor,
    ) -> None:
        """
