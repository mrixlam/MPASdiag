...
class TestValidateCoordinateRangeError:
    ...
    def test_appends_error_when_min_ge_max(
        self: "TestValidateCoordinateRangeError",
    ) -> None:
        """
...
class TestReportValidationErrorsWithLogger:
    ...
    def test_uses_logger_error_when_logger_is_set(
        self: "TestReportValidationErrorsWithLogger",
    ) -> None:
        """
...
class TestValidateConfigNoDataFiles:
    ...
    def test_returns_false_when_dir_exists_but_no_data_files(
        self: "TestValidateConfigNoDataFiles", tmp_path: "Path"
    ) -> None:
        """
...
class TestCheckAnalysisTypeSpecifiedFalse:
    ...
    def test_returns_false_when_analysis_type_is_none(
        self: "TestCheckAnalysisTypeSpecifiedFalse",
    ) -> None:
        """
    ...
    def test_run_analysis_returns_false_when_no_analysis_type(
        self: "TestCheckAnalysisTypeSpecifiedFalse",
    ) -> None:
        """
...
class TestDispatchAnalysisNoneType:
    ...
    def test_returns_none_for_falsy_analysis_type(
        self: "TestDispatchAnalysisNoneType",
    ) -> None:
        """
...
class TestRunSingleCrossSectionLowerHalf:
    ...
    def test_saves_and_closes_plot_with_logger(
        self: "TestRunSingleCrossSectionLowerHalf",
    ) -> None:
        """
        ...
        with tempfile.TemporaryDirectory() as safe_tmp_dir:
            ...
            with patch(
                ...
                cli._run_single_cross_section(
                    mock_processor, mock_plotter, config, params
                )

            mock_plotter.save_plot.assert_called_once()
            mock_plotter.close_plot.assert_called_once()

    def test_uses_config_output_when_set(
...
class TestLogCreatedFilesWithLogger:
    ...
    def test_calls_logger_info_with_file_count(
        self: "TestLogCreatedFilesWithLogger",
        tmp_path: "Path",
        ...
        """
        cli = MPASUnifiedCLI()
        cli._log_created_files(
            [str(tmp_path / "a.png"), str(tmp_path / "b.png")], "test plots"
        )
        captured = capsys.readouterr()
        assert "2" in captured.out
        assert "test plots" in captured.out

    def test_does_nothing_when_files_is_empty(
        self: "TestLogCreatedFilesWithLogger",
    ) -> None:
        """
...
class TestComputeSoundingIndices:
    ...
    def test_returns_none_when_show_indices_is_false(
        self: "TestComputeSoundingIndices",
    ) -> None:
        """
    ...
    def test_calls_diagnostics_when_show_indices_is_true(
        self: "TestComputeSoundingIndices",
    ) -> None:
        """
...
class TestRunSoundingBatch:
    ...
    def test_iterates_over_time_range_and_creates_diagrams(
        self: "TestRunSoundingBatch", tmp_path: "Path"
    ) -> None:
        """
    ...
    def test_uses_none_time_bounds_defaults(
        self: "TestRunSoundingBatch", tmp_path: "Path"
    ) -> None:
        """
...
class TestRunSoundingSingle:
    ...
    def test_creates_and_saves_skewt_diagram(
        self: "TestRunSoundingSingle", tmp_path: "Path"
    ) -> None:
        """
    ...
    def test_uses_explicit_output_name_when_set(
        self: "TestRunSoundingSingle", tmp_path: "Path"
    ) -> None:
        """
...
class TestRunSoundingAnalysis:
    ...
    def test_single_mode_returns_true(
        self: "TestRunSoundingAnalysis", tmp_path: "Path"
    ) -> None:
        """
        ...
        with (
            patch("mpasdiag.processing.cli_unified.MPAS3DProcessor") as MockProc,
            patch(
                "mpasdiag.processing.cli_unified.SoundingDiagnostics",
    ...
    def test_batch_mode_with_show_indices_returns_true(
        self: "TestRunSoundingAnalysis", tmp_path: "Path"
    ) -> None:
        """
...
class TestParseArgsWithReorderingFallback:
    ...
    def test_except_branch_returns_fallback_parse(
        self: "TestParseArgsWithReorderingFallback",
    ) -> None:
        """
...
class TestHandleMainExceptionNoLogger:
    ...
    def test_prints_error_and_returns_one_when_no_logger(
        self: "TestHandleMainExceptionNoLogger", capsys: pytest.CaptureFixture
    ) -> None:
        """
...
class TestPrintSystemInfoImportError:
    ...
    def test_handles_missing_psutil_gracefully(
        self: "TestPrintSystemInfoImportError",
    ) -> None:
        """
