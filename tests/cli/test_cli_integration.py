...
class TestIntegrationWithRealData:
    ...
    def test_run_precipitation_analysis_with_real_data(
    ...
    def test_run_surface_analysis_with_real_data(
        self: "TestIntegrationWithRealData", grid_file: str, test_data_dir: str
    ) -> None:
        """
    ...
    def test_run_wind_analysis_with_real_data(
        self: "TestIntegrationWithRealData", grid_file: str, test_data_dir: str
    ) -> None:
        """
    ...
    def test_run_precipitation_analysis_batch_mode(
        self: "TestIntegrationWithRealData", grid_file: str, test_data_dir: str
    ) -> None:
        """
    ...
    def test_run_surface_analysis_with_spatial_bounds(
        self: "TestIntegrationWithRealData", grid_file: str, test_data_dir: str
    ) -> None:
        """
