...
class TestMainFunctionAndArgumentHandling:
    ...
    def test_main_with_config_file_loading(
    ...
    def test_main_with_verbose_system_info(
        self: "TestMainFunctionAndArgumentHandling",
    ) -> None:
        """
...
class TestMainArgumentReorderingUnifiedFinal:
    ...
    def test_main_with_global_arg_equals_format(
        self: "TestMainArgumentReorderingUnifiedFinal",
    ) -> None:
        """
    ...
    def test_main_with_global_arg_at_end(
        self: "TestMainArgumentReorderingUnifiedFinal",
    ) -> None:
        """
