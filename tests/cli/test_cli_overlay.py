...
class TestOverlayAndCompositeAnalysis:
    ...
    def test_overlay_analysis_without_type(
        self: "TestOverlayAndCompositeAnalysis", grid_file: str, test_data_dir: str
    ) -> None:
        """
    ...
    def test_run_overlay_analysis_precip_wind(
        self: "TestOverlayAndCompositeAnalysis", grid_file: str, test_data_dir: str
    ) -> None:
        """
    ...
    def test_run_overlay_analysis_temp_pressure(
        self: "TestOverlayAndCompositeAnalysis", grid_file: str, test_data_dir: str
    ) -> None:
        """
