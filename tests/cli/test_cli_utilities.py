...
class TestUtilityFunctions:
    ...
    def test_print_config_summary_with_values(self: "TestUtilityFunctions") -> None:
        ...
        cli.config = MPASConfig(grid_file="test.nc", data_dir="data/", verbose=True)

        cli._print_config_summary()

    def test_print_config_summary_filters_none_values(
        ...
        cli.config = MPASConfig(
            grid_file="test.nc", data_dir="data/", output_dir="", verbose=True
        )
