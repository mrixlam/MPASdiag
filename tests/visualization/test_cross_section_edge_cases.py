...
class TestAdditionalCoverage:
    ...
    def _create_basic_processor(self: "TestAdditionalCoverage") -> Mock:
        ...
        ds = xr.Dataset(
            {
                "theta": (
                    ...
                    np.full((2, 10, 100), 270.0)
                    + _RNG.standard_normal((2, 10, 100)) * 10.0,
                ),
        ...
        mock_processor.get_vertical_levels = Mock(return_value=np.arange(10))
    ...
    def test_unit_conversion_success_path(self: "TestAdditionalCoverage") -> None:
        ...
        with (
            patch(
                "mpasdiag.visualization.cross_section.MPASFileMetadata.get_variable_metadata"
            ) as mock_meta,
            patch(
                "mpasdiag.visualization.cross_section.UnitConverter.get_display_units"
            ) as mock_display,
            patch(
                "mpasdiag.visualization.cross_section.UnitConverter.convert_units"
            ) as mock_convert,
        ):
            ...
            mock_convert.return_value = (
                np.full((10, 20), 15.0) + _RNG.standard_normal((10, 20)) * 5.0
            )
    ...
    def test_display_vertical_pressure_non_finite(
        self: "TestAdditionalCoverage",
    ) -> None:
        """
    ...
    def test_contour_plot_type_lines(self: "TestAdditionalCoverage") -> None:
        ...
        fig, _ = self.plotter.create_vertical_cross_section(
            ...
            style=CrossSectionStyle(
                levels=np.linspace(250, 300, 11), plot_type="contour"
            ),
        )
    ...
    def test_vertical_levels_pressure_extraction(
        self: "TestAdditionalCoverage",
    ) -> None:
        """
    ...
    def test_vertical_levels_exception_n_vert_levels_p1(
        self: "TestAdditionalCoverage",
    ) -> None:
        """
    ...
    def test_level_data_with_get_3d_method(self: "TestAdditionalCoverage") -> None:
        ...
        mock_processor.get_3d_variable_data = Mock(return_value=_RNG.random(100))
    ...
    def test_format_axes_pressure_hpa_max_height(
        self: "TestAdditionalCoverage",
    ) -> None:
        """
