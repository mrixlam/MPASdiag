...
def _find_3d_var(processor: MPAS3DProcessor) -> Union[str, None]:
    ...
    for v in processor.dataset.data_vars:
        if (
            "nVertLevels" in processor.dataset[v].sizes
            or "nVertLevelsP1" in processor.dataset[v].sizes
        ):
            return str(v)
    return None
...
class TestCreateVerticalCrossSectionComplete:
    ...
    def test_create_cross_section_filled_contour(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_contour_only(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_pcolormesh(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_model_levels(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_height_coord(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_display_vertical_pressure(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_display_vertical_height(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_display_vertical_model_levels(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_with_max_height(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_custom_colormap(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_custom_levels(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_custom_title(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_save_file(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
    ...
    def test_create_cross_section_invalid_plot_type(
        self: "TestCreateVerticalCrossSectionComplete",
    ) -> None:
        """
...
class TestVerticalCoordinateConversion:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestVerticalCoordinateConversion", mpas_3d_processor: "MPAS3DProcessor"
    ) -> Generator[None, None, None]:
        """
    ...
    def test_convert_pressure_to_height(
        self: "TestVerticalCoordinateConversion",
    ) -> None:
        """
        ...
        height_display, coord_type = self.plotter._convert_vertical_to_height(
            pressure_coords, "pressure", self.processor, time_index=0
        )
    ...
    def test_convert_model_levels_to_height(
        self: "TestVerticalCoordinateConversion",
    ) -> None:
        """
        ...
        height_display, coord_type = self.plotter._convert_vertical_to_height(
            modlev, "modlev", self.processor, time_index=0
        )
...
class TestVerticalCoordinateEdgeCases:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestVerticalCoordinateEdgeCases", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_pressure_conversion_exception_path(
        self: "TestVerticalCoordinateEdgeCases",
    ) -> None:
        """
    ...
    def test_non_finite_pressure_values_fallback(
        self: "TestVerticalCoordinateEdgeCases",
    ) -> None:
        """
        ...
        with patch.object(plotter, "_generate_cross_section_data") as mock_gen:
            ...
            fig, ax = plotter.create_vertical_cross_section(
                processor, var_3d, (-100, 30), (-90, 40), display_vertical="pressure"
            )

            assert "Model" in ax.get_ylabel()
            plt.close(fig)

    def test_pressure_in_pascals_conversion(
        self: "TestVerticalCoordinateEdgeCases",
    ) -> None:
        """
    ...
    def test_max_height_no_valid_data_warning(
        self: "TestVerticalCoordinateEdgeCases",
    ) -> None:
        """
        ...
        with patch.object(plotter, "_generate_cross_section_data") as mock_gen:
            ...
            fig, _ = plotter.create_vertical_cross_section(
                processor, var_3d, (-100, 30), (-90, 40), max_height=10.0
            )
...
class TestVerticalCoordinateEdgeCasesFinal:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestVerticalCoordinateEdgeCasesFinal",
        ...
        """
        if (
            mpas_3d_processor is None
            or not os.path.exists(GRID_FILE)
    ...
    def test_vertical_coords_with_nan_values(
        self: "TestVerticalCoordinateEdgeCasesFinal",
    ) -> None:
        """
        ...
        with patch.object(
            self.processor,
            "get_vertical_levels",
            return_value=pressure_with_nan.tolist(),
        ):
            fig, _ = self.plotter.create_vertical_cross_section(
                self.processor,
                var_3d,
    ...
    def test_pressure_unit_detection_pa(
        self: "TestVerticalCoordinateEdgeCasesFinal",
    ) -> None:
        """
    ...
    def test_model_levels_coordinate_system(
        self: "TestVerticalCoordinateEdgeCasesFinal",
    ) -> None:
        """
