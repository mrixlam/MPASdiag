...
class TestConvertPrecipitationUnits:
    ...
    def test_none_data_array_returns_original(
        self: "TestConvertPrecipitationUnits",
    ) -> None:
        """
    ...
    def test_non_ndarray_precip_passes_through(
        self: "TestConvertPrecipitationUnits",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.precipitation.UnitConverter.convert_data_for_display",
            return_value=(da, {"units": "mm"}),
        ):
            _, label = plotter._convert_precipitation_units(da, da, "rainnc")
        assert label == "mm"

    def test_attribute_error_returns_original_with_fallback_metadata(
        self: "TestConvertPrecipitationUnits",
    ) -> None:
        """
        ...
        data_array = xr.DataArray(
            precip, dims=["nCells"], attrs={"units": "mm", "long_name": "Rain"}
        )
        ...
        with patch(
            ...
            data, label = plotter._convert_precipitation_units(
                precip, data_array, "rainnc"
            )
...
class TestPreparePrecipitationColormap:
    ...
    def test_custom_colormap_only_uses_default_levels(
        self: "TestPreparePrecipitationColormap",
    ) -> None:
        """
    ...
    def test_custom_colormap_and_levels_both_used(
        self: "TestPreparePrecipitationColormap",
    ) -> None:
        """
    ...
    def test_clim_filtering_restricts_levels(
        self: "TestPreparePrecipitationColormap",
    ) -> None:
        """
    ...
    def test_clim_min_inserted_when_absent(
        self: "TestPreparePrecipitationColormap",
    ) -> None:
        """
    ...
    def test_clim_max_appended_when_absent(
        self: "TestPreparePrecipitationColormap",
    ) -> None:
        """
        ...
        _, _, levels = plotter._prepare_precipitation_colormap(
            ...
            accum_period="a01h",
            clim_min=0.0,
            clim_max=3.7,  # 3.7 not in [0.5,1.0,2.0] → appended
        )
...
class TestAddTimeAnnotation:
    ...
    def test_no_time_but_accum_period_adds_annotation(
        self: "TestAddTimeAnnotation",
    ) -> None:
        """
...
class TestCreatePrecipitationMapContour:
    ...
    def test_contour_plot_type_calls_create_contour_plot(
        self: "TestCreatePrecipitationMapContour",
    ) -> None:
        """
...
class TestSetupOverlayColormap:
    ...
    def test_colormap_and_levels_both_provided(
        self: "TestSetupOverlayColormap",
    ) -> None:
        """
    ...
    def test_colormap_only_uses_default_levels(
        self: "TestSetupOverlayColormap",
    ) -> None:
        """
    ...
    def test_neither_colormap_nor_levels_uses_defaults(
        self: "TestSetupOverlayColormap",
    ) -> None:
        """
...
class TestCalculateOverlayGridResolution:
    ...
    def test_explicit_resolution_returned(
        self: "TestCalculateOverlayGridResolution",
    ) -> None:
        """
        ...
        """
        plotter = MPASPrecipitationPlotter()
        result = plotter._calculate_overlay_grid_resolution(
            0.25, LON_MIN, LON_MAX, LAT_MIN, LAT_MAX
        )
        assert result == pytest.approx(0.25)

    def test_adaptive_resolution_when_none(
        self: "TestCalculateOverlayGridResolution",
    ) -> None:
        """
...
class TestAddPrecipitationOverlayValidation:
    ...
    def test_invalid_plot_type_raises(
        self: "TestAddPrecipitationOverlayValidation",
    ) -> None:
        """
...
class TestExtractCoordinatesFromProcessor:
    ...
    def test_extract_spatial_coordinates_fallback(
        self: "TestExtractCoordinatesFromProcessor",
    ) -> None:
        """
    ...
    def test_direct_dataset_access_fallback(
        self: "TestExtractCoordinatesFromProcessor",
    ) -> None:
        """
    ...
    def test_attribute_error_fallback(
        self: "TestExtractCoordinatesFromProcessor",
    ) -> None:
        """
...
class TestSetupBatchTimeIndices:
    ...
    def _make_proc(self: "TestSetupBatchTimeIndices", n_times: int) -> MagicMock:
        """
    ...
    def test_insufficient_time_steps_returns_empty(
        self: "TestSetupBatchTimeIndices",
    ) -> None:
        """
        ...
        """
        plotter = MPASPrecipitationPlotter()
        result, hours = plotter._setup_batch_time_indices(
            self._make_proc(1), "a24h", None
        )
        assert result == []
        assert hours == 24

    def test_insufficient_steps_prints_warning(
        self: "TestSetupBatchTimeIndices", capsys: "pytest.CaptureFixture"
    ) -> None:
        """
    ...
    def test_valid_user_indices_returned(self: "TestSetupBatchTimeIndices") -> None:
        ...
        """
        plotter = MPASPrecipitationPlotter()
        result, _ = plotter._setup_batch_time_indices(
            self._make_proc(10), "a01h", [1, 2, 3]
        )
        assert result == [1, 2, 3]
...
class TestProcessSingleTimeStep:
    ...
    def test_no_time_coordinate_uses_index_string(
        self: "TestProcessSingleTimeStep", tmp_path: "Path"
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.precipitation.PrecipitationDiagnostics"
        ) as mock_cls:
            mock_cls.return_value.compute_precipitation_difference.return_value = (
                precip_da
            )
            with patch.object(
                plotter,
    ...
    def test_custom_title_template_applied(
        self: "TestProcessSingleTimeStep", tmp_path: "Path"
    ) -> None:
        """
        ...
        def capture_title(*args: Any, **kwargs: Any) -> tuple:
            """
        ...
        with patch(
            ...
            with patch.object(
                plotter, "create_precipitation_map", side_effect=capture_title
            ):
                with patch.object(plotter, "save_plot"):
                    with patch.object(plotter, "close_plot"):
...
class TestCreateBatchPrecipitationMaps:
    ...
    def test_processor_none_raises(
    ...
    def test_progress_print_every_10_steps(
        self: "TestCreateBatchPrecipitationMaps",
        tmp_path: "Path",
        ...
        with patch.object(
            plotter, "_process_single_time_step", return_value=["file.png"]
        ):
            result = plotter.create_batch_precipitation_maps(
                proc,
                str(tmp_path),
    ...
    def test_exception_in_time_step_continues(
        self: "TestCreateBatchPrecipitationMaps",
        tmp_path: "Path",
        capsys: "pytest.CaptureFixture",
    ) -> None:
...
class TestRenderOverlayInterpolated:
    ...
    def test_config_dispatch_remap_path(self: "TestRenderOverlayInterpolated") -> None:
        ...
        with patch(
            "mpasdiag.visualization.precipitation.dispatch_remap", return_value=remapped
        ):
            plotter._render_overlay_interpolated(
                ...
                None,
                OverlayColorSpec(
                    plt.get_cmap("Blues"), MagicMock(), [1.0, 2.0, 5.0], 0.7
                ),
                lon,
                lat,
                config=mock_config,
    ...
    def test_config_dispatch_with_none_dataset_creates_dataset(
        self: "TestRenderOverlayInterpolated",
    ) -> None:
        """
    ...
    def test_esmpy_path_exception_falls_back_to_kdtree(
        self: "TestRenderOverlayInterpolated",
    ) -> None:
        """
        ...
        with patch("mpasdiag.visualization.precipitation.ESMPY_AVAILABLE", True):
            with patch.object(plotter, "_has_boundary_data", return_value=True):
                with patch.object(plotter, "_ensure_boundary_data", return_value=None):
                    with patch.object(
                        plotter,
                        "_backmap_to_full_grid",
                        side_effect=RuntimeError("ESMPy error"),
                    ):
                        with patch(
                            "mpasdiag.visualization.precipitation"
    ...
    def test_contour_plot_type_calls_contour_and_clabel(
        self: "TestRenderOverlayInterpolated",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.precipitation.remap_mpas_to_latlon_with_masking",
            return_value=remapped,
        ):
            plotter._render_overlay_interpolated(
                mock_ax,
    ...
    def test_contour_clabel_exception_silenced(
        self: "TestRenderOverlayInterpolated",
    ) -> None:
        """
...
class TestSetupComparisonSubplot:
    ...
    def test_regional_extent_calls_set_extent(
        self: "TestSetupComparisonSubplot",
    ) -> None:
        """
...
class TestPlotPrecipitationData:
    ...
    def test_out_of_bounds_data_returns_none(self: "TestPlotPrecipitationData") -> None:
        ...
        fig, ax = _make_geo_ax()
        data_crs = ccrs.PlateCarree()
        lon = np.linspace(-180.0, -150.0, N_CELLS)
        data = _precip(2.0)
        try:
            result = plotter._plot_precipitation_data(
                ax,
...
class TestSavePlot:
    ...
    def test_no_figure_raises(self: "TestSavePlot", tmp_path: "Path") -> None:
        """
...
class TestApplyStyle:
    ...
    def test_apply_style_calls_style_manager_when_present(
        self: "TestApplyStyle",
    ) -> None:
        """
...
class TestCreatePrecipitationComparisonPlot:
    ...
    def test_colorbar_ticks_set_when_cbar_not_none(
        self: "TestCreatePrecipitationComparisonPlot",
    ) -> None:
        """
    ...
    def test_colorbar_tick_exception_silenced(
        self: "TestCreatePrecipitationComparisonPlot",
    ) -> None:
        """
