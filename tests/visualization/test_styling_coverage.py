...
class TestCreatePrecipColormapException:
    ...
    def test_re_search_exception_sets_hours_none(
        self: "TestCreatePrecipColormapException",
    ) -> None:
        """
...
class TestGenerateLevelsFromData:
    ...
    def test_small_temp_range_uses_step_half(
        self: "TestGenerateLevelsFromData",
    ) -> None:
        """
    ...
    def test_exception_in_values_returns_none(
        self: "TestGenerateLevelsFromData",
    ) -> None:
        """
        ...
        result = MPASVisualizationStyle._generate_levels_from_data(
            BadDataArray(), "t2m"
        )
...
class TestLevelsForTemperature:
    ...
    def test_data_range_at_most_20_uses_step_1(
        self: "TestLevelsForTemperature",
    ) -> None:
        """
    ...
    def test_data_range_between_20_and_40_uses_step_2(
        self: "TestLevelsForTemperature",
    ) -> None:
        """
...
class TestLevelsForPrecipitation:
    ...
    def test_no_matching_pattern_uses_else_a24h(
        self: "TestLevelsForPrecipitation",
    ) -> None:
        """
...
class TestLevelsForGeopotential:
    ...
    def test_large_height_range_uses_step_30_or_60(
        self: "TestLevelsForGeopotential",
    ) -> None:
        """
    ...
    def test_very_large_height_range_uses_step_60(
        self: "TestLevelsForGeopotential",
    ) -> None:
        """
...
class TestLevelsForHumidity:
    ...
    def test_small_range_non_rh_var_uses_log_style_levels(
        self: "TestLevelsForHumidity",
    ) -> None:
        """
...
class TestGetVariableSpecificSettings:
    ...
    def test_xarray_input_uses_values_flatten(
        self: "TestGetVariableSpecificSettings",
    ) -> None:
        """
        ...
        colormap, levels = MPASVisualizationStyle.get_variable_specific_settings(
            "wind_speed", da
        )
        assert colormap is not None
        assert levels is not None

    def test_all_nan_data_returns_viridis_none(
        self: "TestGetVariableSpecificSettings",
    ) -> None:
        """
    ...
    def test_all_nan_xarray_returns_viridis_none(
        self: "TestGetVariableSpecificSettings",
    ) -> None:
        """
...
class TestSetupMapProjection:
    ...
    def test_lambertconformal_returns_lcc_projection(
        ...
        proj, _ = MPASVisualizationStyle.setup_map_projection(
            -100.0, -80.0, 30.0, 50.0, projection="LambertConformal"
        )
        assert isinstance(proj, ccrs.LambertConformal)

    def test_unknown_projection_falls_back_to_platecarree(
        self: "TestSetupMapProjection",
    ) -> None:
        """
        ...
        proj, _ = MPASVisualizationStyle.setup_map_projection(
            -100.0, -80.0, 30.0, 50.0, projection="UnknownProjection"
        )
...
class TestSavePlot:
    ...
    def test_none_figure_raises_value_error(
        self: "TestSavePlot", tmp_path: "Path"
    ) -> None:
        """
...
class TestConfigureHorizontalColorbar:
    ...
    def test_set_label_position_exception_is_silenced(
        self: "TestConfigureHorizontalColorbar",
    ) -> None:
        """
    ...
    def test_set_label_failure_falls_back_to_set_xlabel(
        self: "TestConfigureHorizontalColorbar",
    ) -> None:
        """
    ...
    def test_with_no_label_skips_label_setting(
        self: "TestConfigureHorizontalColorbar",
    ) -> None:
        """
...
class TestConfigureVerticalColorbar:
    ...
    def test_set_label_position_exception_is_silenced(
        self: "TestConfigureVerticalColorbar",
    ) -> None:
        """
    ...
    def test_set_label_failure_falls_back_to_set_ylabel(
        self: "TestConfigureVerticalColorbar",
    ) -> None:
        """
...
class TestApplyColorbarFormatter:
    ...
    def test_exception_in_formatter_is_silenced(
        self: "TestApplyColorbarFormatter",
    ) -> None:
        """
...
class TestAddColorbarWithFormatter:
    ...
    def test_add_colorbar_fmt_none_skips_formatter(
        self: "TestAddColorbarWithFormatter",
    ) -> None:
        """
...
class TestBuildColorbarLabel:
    ...
    def test_default_long_name_used_when_metadata_missing(
    ...
    def test_default_units_used_when_metadata_missing(
        self: "TestBuildColorbarLabel",
    ) -> None:
        """
    ...
    def test_long_name_only_returned_without_units(
        self: "TestBuildColorbarLabel",
    ) -> None:
        """
    ...
    def test_units_already_embedded_returns_long_name_as_is(
        self: "TestBuildColorbarLabel",
    ) -> None:
        """
    ...
    def test_none_metadata_no_defaults_returns_none(
        self: "TestBuildColorbarLabel",
    ) -> None:
        """
...
class TestCalculateAdaptiveMarkerSize:
    ...
    def test_density_10_to_50_branch(self: "TestCalculateAdaptiveMarkerSize") -> None:
        ...
        result = MPASVisualizationStyle.calculate_adaptive_marker_size(
            (-100.0, -90.0, 30.0, 40.0), num_points=2000
        )
    ...
    def test_density_50_to_150_branch(self: "TestCalculateAdaptiveMarkerSize") -> None:
        ...
        """
        result = MPASVisualizationStyle.calculate_adaptive_marker_size(
            (-100.0, -90.0, 30.0, 40.0), num_points=7500
        )
        assert isinstance(result, float)
    ...
    def test_density_150_to_500_branch(self: "TestCalculateAdaptiveMarkerSize") -> None:
        ...
        """
        result = MPASVisualizationStyle.calculate_adaptive_marker_size(
            (-100.0, -90.0, 30.0, 40.0), num_points=30_000
        )
        assert isinstance(result, float)
    ...
    def test_density_above_500_branch(self: "TestCalculateAdaptiveMarkerSize") -> None:
        ...
        """
        result = MPASVisualizationStyle.calculate_adaptive_marker_size(
            (-100.0, -90.0, 30.0, 40.0), num_points=100_000
        )
        assert isinstance(result, float)

    def test_small_map_area_uses_large_area_scale(
        self: "TestCalculateAdaptiveMarkerSize",
    ) -> None:
        """
        ...
        """
        result = MPASVisualizationStyle.calculate_adaptive_marker_size(
            (-91.0, -88.0, 30.0, 32.0), num_points=100
        )
        assert isinstance(result, float)
        assert result > 0
...
class TestChooseTickFmt:
    ...
    def test_large_magnitude_non_integer_returns_int_format(
        self: "TestChooseTickFmt",
    ) -> None:
        """
    ...
    def test_medium_magnitude_non_integer_returns_1dp(
        self: "TestChooseTickFmt",
    ) -> None:
        """
...
class TestFormatTicksDynamic:
    ...
    def test_large_magnitude_uses_scientific_notation(
        self: "TestFormatTicksDynamic",
    ) -> None:
        """
    ...
    def test_tiny_values_use_scientific_notation(
        self: "TestFormatTicksDynamic",
    ) -> None:
        """
