...
class TestVerticalLevelExtraction:
    ...
    def setup_method(
        self: "TestVerticalLevelExtraction", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_verbose_integer_vertical_levels(
        self: "TestVerticalLevelExtraction",
    ) -> None:
        """
        ...
        with patch.object(
            processor, "get_vertical_levels", return_value=np.arange(10, dtype=int)
        ):
    ...
    def test_vertical_levels_exception_handling(
        self: "TestVerticalLevelExtraction",
    ) -> None:
        """
        ...
        with patch.object(
            processor, "get_vertical_levels", side_effect=Exception("Level error")
        ):
            fig, _ = plotter.create_vertical_cross_section(
                processor, "theta", (-100, 30), (-90, 40)
            )
    ...
    def test_path_outside_grid_domain_warning(
        self: "TestVerticalLevelExtraction",
    ) -> None:
        """
        ...
        fig, _ = plotter.create_vertical_cross_section(
            processor, "theta", (0, 0), (90, 80), num_points=20
        )

        plt.close(fig)

    def test_level_extraction_with_nvertlevelsp1(
        self: "TestVerticalLevelExtraction",
    ) -> None:
        """
        ...
        if "w" in processor.dataset.data_vars:
            ...
            fig, _ = plotter.create_vertical_cross_section(
                processor, "w", (-100, 30), (-90, 40), num_points=20
            )
            plt.close(fig)

    def test_level_extraction_exception_continue(
        self: "TestVerticalLevelExtraction",
    ) -> None:
        """
...
class TestVerticalToHeightConversion:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestVerticalToHeightConversion", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_pressure_to_height_with_zgrid(
        self: "TestVerticalToHeightConversion",
    ) -> None:
        """
    ...
    def test_pressure_to_height_standard_atmosphere(
        self: "TestVerticalToHeightConversion",
    ) -> None:
        """
    ...
    def test_model_levels_with_height_variable(
        self: "TestVerticalToHeightConversion",
    ) -> None:
        """
...
class TestHeightCoordinates:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestHeightCoordinates", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
