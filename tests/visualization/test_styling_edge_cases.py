...
class TestPrecipitationPeriodBranches:
    ...
    def test_precip_style_with_2h_period(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_4h_period(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_8h_period(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_18h_period(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_48h_period(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_daily_keyword(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_with_hourly_keyword(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
    ...
    def test_precip_style_no_period_match(
        self: "TestPrecipitationPeriodBranches",
    ) -> None:
        """
...
class TestGenerateLevelsException:
    ...
    def test_generate_levels_exception_in_get_variable_style(
        self: "TestGenerateLevelsException",
    ) -> None:
        """
