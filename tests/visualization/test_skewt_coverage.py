...
class TestCreateSkewTSaveVerbose:
    ...
    def test_verbose_prints_saved_path(
        self: "TestCreateSkewTSaveVerbose", tmp_path: "Path"
    ) -> None:
        """
        ...
        with patch.object(
            plotter, "_create_metpy_skewt", return_value=(mock_fig, mock_ax)
        ):
    ...
    def test_verbose_false_no_print_after_save(
        self: "TestCreateSkewTSaveVerbose", tmp_path: "Path"
    ) -> None:
        """
    ...
    def test_no_save_path_skips_save_and_print(
        self: "TestCreateSkewTSaveVerbose",
    ) -> None:
        """
        ...
        with patch.object(
            ...
            with patch(
                "mpasdiag.visualization.skewt.MPASVisualizationStyle.save_plot"
            ) as mock_save:
                with patch.object(plotter, "add_timestamp_and_branding"):
                    captured = StringIO()
                    with patch("sys.stdout", new=captured):
...
class TestPlotParcelProfileException:
    ...
    def test_exception_verbose_prints_warning(
        self: "TestPlotParcelProfileException",
    ) -> None:
        """
    ...
    def test_exception_verbose_false_silent(
        self: "TestPlotParcelProfileException",
    ) -> None:
        """
    ...
    def test_exception_with_indices_still_caught(
        self: "TestPlotParcelProfileException",
    ) -> None:
        """
