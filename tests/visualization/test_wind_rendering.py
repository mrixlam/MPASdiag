...
class TestRegridWindComponents:
    ...
    def test_regrid_linear_method(
        ...
        dataset = xr.Dataset({"lonCell": ("nCells", lon), "latCell": ("nCells", lat)})
...
class TestCreateWindPlot:
    ...
    def test_create_wind_plot_basic(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
    ...
    def test_create_wind_plot_auto_subsample(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_global_extent(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_custom_title(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_with_timestamp(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_with_level_info(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_with_regridding(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_streamlines_auto_regrid(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_create_wind_plot_2d_data(
        self: "TestCreateWindPlot",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
