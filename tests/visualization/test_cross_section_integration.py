...
class TestRealDataIntegration:
    ...
    def setup_method(
        self: "TestRealDataIntegration", mpas_3d_processor: MPAS3DProcessor
    ...
    def test_all_vertical_coords_with_real_data(
        self: "TestRealDataIntegration",
    ) -> None:
        """
...
class TestRealMPASDataIntegration:
    ...
    def test_real_data_cross_section_with_pressure(
        self: "TestRealMPASDataIntegration", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_real_data_cross_section_with_height(
        self: "TestRealMPASDataIntegration", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
