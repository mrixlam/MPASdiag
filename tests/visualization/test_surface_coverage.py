...
class TestExtractAndConvertUnitsEdgeCases:
    ...
    def test_attrs_access_exception_is_swallowed(
        self: "TestExtractAndConvertUnitsEdgeCases",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.surface.MPASFileMetadata"
    ...
    def test_data_with_attrs_provides_units(
        self: "TestExtractAndConvertUnitsEdgeCases",
    ) -> None:
        """
    ...
    def test_moisture_negative_values_clipped_to_zero(
        self: "TestExtractAndConvertUnitsEdgeCases",
    ) -> None:
        """
    ...
    def test_moisture_positive_only_unchanged(
        self: "TestExtractAndConvertUnitsEdgeCases",
    ) -> None:
        """
...
class TestSetupMapExtentAndFeatures:
    ...
    def test_global_extent_sets_extended_filter_bounds(
        self: "TestSetupMapExtentAndFeatures",
    ) -> None:
        """
        ...
        _, _, _, _, _, _, fld_min, fld_max, flatd_min, flatd_max = result
    ...
    def test_regional_extent_uses_provided_bounds_directly(
        self: "TestSetupMapExtentAndFeatures",
    ) -> None:
        """
...
class TestFilterValidDataDask:
    ...
    def test_computable_mask_compute_is_called(self: "TestFilterValidDataDask") -> None:
        ...
        plotter = MPASSurfacePlotter()
        with patch(
            "mpasdiag.visualization.surface.np.isfinite", side_effect=_fake_isfinite
        ):
...
class TestAddSurfaceOverlayWrapper:
    ...
    def test_public_method_delegates_to_private(
        self: "TestAddSurfaceOverlayWrapper",
    ) -> None:
        """
...
class TestApplyOverlayUnitConversion:
    ...
    def test_successful_conversion_pa_to_hpa(
        self: "TestApplyOverlayUnitConversion",
    ) -> None:
        """
    ...
    def test_valueerror_from_convert_is_caught(
        self: "TestApplyOverlayUnitConversion",
    ) -> None:
        """
        ...
        overlay = np.ones(N_CELLS) * 101325.0
        with patch(
            "mpasdiag.visualization.surface.UnitConverter.convert_units",
            side_effect=ValueError("incompatible units"),
        ):
            result = plotter._apply_overlay_unit_conversion(overlay, "mslp", "Pa")
        assert np.allclose(result, overlay)

    def test_same_units_skips_conversion(
        self: "TestApplyOverlayUnitConversion",
    ) -> None:
        """
...
class TestPrepareOverlayData:
    ...
    def test_no_original_units_skips_explicit_conversion(
        self: "TestPrepareOverlayData",
    ) -> None:
        """
...
class TestCalculateOverlayResolution:
    ...
    def test_explicit_resolution_returned_as_float(
        self: "TestCalculateOverlayResolution",
    ) -> None:
        """
    ...
    def test_explicit_resolution_as_int_converted(
        self: "TestCalculateOverlayResolution",
    ) -> None:
        """
    ...
    def test_none_resolution_uses_adaptive(
        self: "TestCalculateOverlayResolution",
    ) -> None:
        """
...
class TestCreateOverlayDataset:
    ...
    def test_existing_dataset_returned_unchanged(
        self: "TestCreateOverlayDataset",
    ) -> None:
        """
...
class TestInterpolateOverlayWithConfig:
    ...
    def test_dispatch_remap_called_when_config_not_none(
        self: "TestInterpolateOverlayWithConfig",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.surface.dispatch_remap", return_value=mock_remapped
        ) as mock_dispatch:
...
class TestValidateContourLevels:
    ...
    def test_no_levels_in_range_triggers_warning(
        self: "TestValidateContourLevels",
    ) -> None:
        """
...
class TestCreateBatchSurfaceMaps:
    ...
    def test_no_dataset_raises_valueerror(
        self: "TestCreateBatchSurfaceMaps", tmp_path: "Path"
    ) -> None:
        """
    ...
    def test_progress_printed_at_step_10(
        ...
        proc.extract_2d_coordinates_for_variable = Mock(
            return_value=(
        ...
        plotter = MPASSurfacePlotter()
        with patch.object(
            plotter, "create_surface_map", return_value=(MagicMock(), MagicMock())
        ):
...
class TestCreateSimpleScatterPlot:
    ...
    def test_all_nan_data_raises_valueerror(
    ...
    def test_colorbar_tickparams_exception_is_suppressed(
        ...
        plotter = MPASSurfacePlotter()
        with patch(
            "mpasdiag.visualization.surface.MPASVisualizationStyle.add_colorbar",
...
class TestPlot3dVariableSlice:
    ...
    def test_basic_3d_slice_delegates_to_create_surface_map(
        self: "TestPlot3dVariableSlice",
    ) -> None:
        """
        ...
        mock_ax = MagicMock()
        with patch.object(
            plotter, "create_surface_map", return_value=(mock_fig, mock_ax)
        ) as mock_create:
    ...
    def test_default_title_uses_metadata(self: "TestPlot3dVariableSlice") -> None:
        ...
        with patch.object(
            ...
            plotter.plot_3d_variable_slice(da, lon, lat, level=1, var_name="qv")
        _, kwargs = mock_create.call_args
        assert kwargs["style"].title is not None
        assert (
            "Level 1" in kwargs["style"].title
            or "level" in kwargs["style"].title.lower()
        )
