...
class TestAddWindOverlay:
    ...
    def test_add_wind_overlay_basic(
        ...
        wind_config = {"u_data": u, "v_data": v, "plot_type": "barbs", "color": "red"}
    ...
    def test_add_wind_overlay_3d_data_with_level(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
    ...
    def test_add_wind_overlay_3d_data_default_level(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        ...
        wind_config = {"u_data": u_3d, "v_data": v_3d}
    ...
    def test_add_wind_overlay_with_regridding(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        ...
        plotter.add_wind_overlay(
            ax, lon, lat, wind_config, lon_min=0, lon_max=50, lat_min=0, lat_max=25
        )
    ...
    def test_add_wind_overlay_regrid_missing_bounds(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        ...
        wind_config = {"u_data": u, "v_data": v, "grid_resolution": 1.0}
    ...
    def test_add_wind_overlay_auto_subsample(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        ...
        wind_config = {"u_data": u, "v_data": v, "subsample": -1}  # Auto-calculate
    ...
    def test_add_wind_overlay_auto_subsample_missing_bounds(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        ...
        wind_config = {"u_data": u, "v_data": v, "subsample": -1}
    ...
    def test_add_wind_overlay_empty_data_1d(
        self: "TestAddWindOverlay",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        monkeypatch: pytest.MonkeyPatch,
    ...
    def test_add_wind_overlay_empty_data_2d(
        ...
        wind_config = {"u_data": u_2d, "v_data": v_2d}
...
class TestCreateBatchWindPlots:
    ...
    def test_create_batch_wind_plots(
        self: "TestCreateBatchWindPlots",
        plotter: "MPASWindPlotter",
        mpas_coordinates: tuple[np.ndarray, np.ndarray],
        mpas_wind_data: tuple[np.ndarray, np.ndarray],
        temp_dir: str,
        ...
        assert len(created_files) == pytest.approx(
            3
        ), f"Expected 3 created files, got {len(created_files)}"
