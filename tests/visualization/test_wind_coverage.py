...
class TestCalculateOptimalSubsample:
    ...
    def test_figsize_none_falls_back_to_instance(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_nonbarbs_plot_type_uses_density_4(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_streamlines_type_also_uses_density_4(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_custom_target_density_is_used(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_large_dataset_triggers_subsample_calculation(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_subsample_capped_at_50(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_small_dataset_returns_1_without_calculation(
        self: "TestCalculateOptimalSubsample", plotter: MPASWindPlotter
    ) -> None:
        """
...
class TestPrepareWindData2D:
    ...
    def test_2d_data_with_subsample_applies_stride(
        self: "TestPrepareWindData2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        Returns:
            None
        """
        lon = np.linspace(-100.0, -80.0, 10).reshape(2, 5)
        lat = np.linspace(30.0, 50.0, 10).reshape(2, 5)
        u = np.ones((2, 5))
        v = np.ones((2, 5))
    ...
    def test_2d_data_no_subsample_returns_original_shape(
        self: "TestPrepareWindData2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        Returns:
            None
        """
        lon = np.linspace(-100.0, -80.0, 6).reshape(2, 3)
        lat = np.linspace(30.0, 50.0, 6).reshape(2, 3)
        u = np.ones((2, 3))
        v = np.ones((2, 3))
...
class TestRenderWindVectorsStreamline1D:
    ...
    def test_streamlines_with_1d_lon_raises(
        self: "TestRenderWindVectorsStreamline1D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        """
        mock_ax = MagicMock()
        lon = np.linspace(-100.0, -80.0, 20)
        lat = np.linspace(30.0, 50.0, 20)
        u = np.ones(20)
        v = np.ones(20)
    ...
    def test_streamlines_error_message_mentions_grid_resolution(
        self: "TestRenderWindVectorsStreamline1D", plotter: MPASWindPlotter
    ) -> None:
        """
...
class TestCalculateValidPointCount2D:
    ...
    def test_2d_count_returns_finite_point_count(
        self: "TestCalculateValidPointCount2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        lon_2d = np.linspace(-100.0, -80.0, 6).reshape(2, 3)
        u_2d = np.array([[1.0, 2.0, np.nan], [4.0, 5.0, 6.0]])
        result = plotter._calculate_valid_point_count(lon_2d, u_2d)
        assert result == 5  # 5 valid (one NaN in u)

    def test_2d_count_all_valid(
        self: "TestCalculateValidPointCount2D", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_2d_count_with_nan_lon(
        self: "TestCalculateValidPointCount2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        Returns:
            None
        """
        lon_2d = np.array([[np.nan, -90.0], [-95.0, -85.0]])
        u_2d = np.ones((2, 2))
        result = plotter._calculate_valid_point_count(lon_2d, u_2d)
...
class TestCreateWindPlotNoValidData:
    ...
    def test_all_nan_u_v_prints_warning_and_returns_early(
        self: "TestCreateWindPlotNoValidData",
        ...
        with patch.object(
            plotter, "_setup_wind_plot_figure", return_value=(mock_fig, mock_ax)
        ):
            with patch.object(
                plotter, "_handle_streamline_regridding", return_value=None
            ):
                fig, ax = plotter.create_wind_plot(
                    ...
                    u_nan,
                    v_nan,
                    GeographicBounds(-100.0, -80.0, 30.0, 50.0),
                )
    ...
    def test_empty_arrays_also_trigger_early_return(
        self: "TestCreateWindPlotNoValidData",
        plotter: MPASWindPlotter,
        capsys: pytest.CaptureFixture,
    ) -> None:
...
class TestExtractWindConfig:
    ...
    def test_non_numeric_subsample_defaults_to_1(
        self: "TestExtractWindConfig", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_none_subsample_defaults_to_1(
        self: "TestExtractWindConfig", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_valid_subsample_string_is_converted(
        self: "TestExtractWindConfig", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_default_subsample_is_1_when_missing(
        self: "TestExtractWindConfig", plotter: MPASWindPlotter
    ) -> None:
        """
...
class TestConvertWindUnits:
    ...
    def test_high_magnitude_warns_when_no_units(
        self: "TestConvertWindUnits",
        plotter: MPASWindPlotter,
        capsys: pytest.CaptureFixture,
    ) -> None:
        """
    ...
    def test_no_units_below_threshold_no_warning(
        self: "TestConvertWindUnits",
        plotter: MPASWindPlotter,
        capsys: pytest.CaptureFixture,
    ) -> None:
    ...
    def test_same_units_returns_data_unchanged(
        self: "TestConvertWindUnits", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_unit_conversion_prints_confirmation(
        self: "TestConvertWindUnits",
        plotter: MPASWindPlotter,
        capsys: pytest.CaptureFixture,
    ) -> None:
        ...
        with patch(
            "mpasdiag.visualization.wind.UnitConverter.convert_units",
    ...
    def test_conversion_failure_prints_warning_and_returns_original(
        self: "TestConvertWindUnits",
        plotter: MPASWindPlotter,
        capsys: pytest.CaptureFixture,
    ) -> None:
    ...
    def test_converted_arrays_returned_as_numpy(
        self: "TestConvertWindUnits", plotter: MPASWindPlotter
    ) -> None:
        """
...
class TestCalculateAutoSubsample2D:
    ...
    def test_2d_lon_triggers_2d_count(
        self: "TestCalculateAutoSubsample2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        result = plotter._calculate_auto_subsample(
            lon_2d, u_2d, -100.0, -80.0, 30.0, 50.0, (12.0, 10.0), "barbs"
        )
        assert isinstance(result, int)
        assert result >= 1

    def test_2d_count_with_nan_excluded(
        self: "TestCalculateAutoSubsample2D", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        u_with_nan = np.array([[1.0, np.nan, 1.0], [1.0, 1.0, 1.0]])
        result_valid = plotter._calculate_auto_subsample(
            lon_2d, u_all_valid, -100.0, -80.0, 30.0, 50.0, (12.0, 10.0), "barbs"
        )
        result_nan = plotter._calculate_auto_subsample(
            lon_2d, u_with_nan, -100.0, -80.0, 30.0, 50.0, (12.0, 10.0), "barbs"
        )
...
class TestCreateBatchWindPlots:
    ...
    def test_dataset_none_raises_value_error(
    ...
    def test_time_info_exception_falls_back_to_time_idx(
        ...
        with patch(
            "mpasdiag.visualization.wind.MPASDateTimeUtils.validate_time_parameters",
            return_value=(0, 0, 1),
        ):
            with patch.object(
                plotter, "create_wind_plot", return_value=(MagicMock(), MagicMock())
            ):
                with patch(
                    "mpasdiag.visualization.wind.MPASDateTimeUtils.get_time_info",
    ...
    def test_time_info_exception_uses_correct_index(
        self: "TestCreateBatchWindPlots", plotter: MPASWindPlotter, tmp_path: "Path"
    ) -> None:
        """
...
class TestExtract2DFrom3DWind:
    ...
    def test_level_index_extracts_correct_slice(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_level_index_zero_extracts_first_level(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_level_value_with_pressure_levels_finds_nearest(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        u2d, v2d = plotter.extract_2d_from_3d_wind(
            u, v, level_value=850.0, pressure_levels=pressure_levels
        )
        np.testing.assert_array_equal(u2d, u[:, 1])  # 850 is at index 1
        np.testing.assert_array_equal(v2d, v[:, 1])

    def test_level_value_nearest_pressure_mid_range(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        u2d, _ = plotter.extract_2d_from_3d_wind(
            u, v, level_value=650.0, pressure_levels=pressure_levels
        )
        np.testing.assert_array_equal(
            u2d, u[:, 2]
        )  # |700-650|=50 < |500-650|=150 → index 2

    def test_level_value_without_pressure_levels_uses_top(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
        ...
        u = _RNG.random((N_CELLS, 5))
        v = _RNG.random((N_CELLS, 5))
        u2d, _ = plotter.extract_2d_from_3d_wind(u, v, level_value=850.0)
        np.testing.assert_array_equal(u2d, u[:, -1])

    def test_default_returns_top_level(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_output_is_2d_slice_shape(
        self: "TestExtract2DFrom3DWind", plotter: MPASWindPlotter
    ) -> None:
        """
...
class TestComputeWindSpeedAndDirection:
    ...
    def test_wind_speed_is_vector_magnitude(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_wind_direction_is_in_0_360_range(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_return_shapes_match_input(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_eastward_wind_direction(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_northward_wind_direction(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
    ...
    def test_both_outputs_are_numpy_arrays(
        self: "TestComputeWindSpeedAndDirection", plotter: MPASWindPlotter
    ) -> None:
        """
