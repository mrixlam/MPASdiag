...
def sample_indices() -> dict[str, float]:
    ...
    return {
        ...
        "cross_totals": 22.0,
        # Moisture
        "precipitable_water": 32.1,
        "wet_bulb_zero_height": 3200.0,
        # Shear / severe
        "bulk_shear_0_1km": 15.0,
        "bulk_shear_0_6km": 35.0,
        "srh_0_1km": 180.0,
        "srh_0_3km": 250.0,
        "stp": 1.5,
        "scp": 8.2,
...
class TestCreateSkewTDiagram:
    ...
    def test_with_title(
        ...
        """
        p, t, td, u, v = sample_profile
        fig, _ = plotter.create_skewt_diagram(p, t, td, u, v, title="Test Sounding")
        assert isinstance(fig, matplotlib.figure.Figure)
        plt.close(fig)
    ...
    def test_with_indices(
        ...
        sample_indices: Mapping[str, Optional[float]],
    ) -> None:
        """
    ...
    def test_with_parcel_and_indices(
        self: "TestCreateSkewTDiagram",
        plotter: "MPASSkewTPlotter",
        sample_profile: tuple[
            np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray
...
class TestSavePlot:
    ...
    def test_save_png(
        ...
        fig, _ = plotter.create_skewt_diagram(p, t, td, u, v, save_path=save_path)
...
class TestEdgeCases:
    ...
    def test_indices_with_none_values(
        self: "TestEdgeCases",
        plotter: "MPASSkewTPlotter",
        sample_profile: tuple[
            np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray
...
class TestIndicesTable:
    ...
    def test_table_with_full_indices(
        self: "TestIndicesTable",
        plotter: "MPASSkewTPlotter",
        sample_profile: tuple[
            np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray
        ],
        sample_indices: dict[str, float],
    ) -> None:
        """
    ...
    def test_table_with_partial_indices(
        self: "TestIndicesTable",
        plotter: "MPASSkewTPlotter",
        sample_profile: tuple[
            np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray
    ...
    def test_table_all_none_no_crash(
        self: "TestIndicesTable",
        plotter: "MPASSkewTPlotter",
        sample_profile: tuple[
            np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray
