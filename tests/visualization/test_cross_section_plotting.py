...
class TestPlotTypeAndLabelingErrors:
    ...
    def setup_method(
        self: "TestPlotTypeAndLabelingErrors", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_colorbar_label_exception_handling(
        self: "TestPlotTypeAndLabelingErrors",
    ) -> None:
        """
        ...
        with patch(
            "mpasdiag.visualization.cross_section.MPASFileMetadata"
        ) as mock_meta:
    ...
    def test_title_exception_handling(self: "TestPlotTypeAndLabelingErrors") -> None:
        ...
        with patch.object(
            plotter, "_get_time_string", side_effect=Exception("Time error")
        ):
            fig, ax = plotter.create_vertical_cross_section(
                processor, "theta", (-100, 30), (-90, 40), title=None
            )
...
class TestPlottingConfigurations:
    ...
    @pytest.fixture(autouse=True)
    def setup_method(
        self: "TestPlottingConfigurations", mpas_3d_processor: "MPAS3DProcessor"
    ) -> None:
        """
    ...
    def test_cross_section_with_custom_colormap(
        self: "TestPlottingConfigurations",
    ) -> None:
        """
